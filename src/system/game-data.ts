...
export class GameData {
      ...
      for (const [skillId, skill] of Object.entries(lockedSkills)) {
        ...
        if (unlockLevel <= currentLevel && !champ.unlockedSkills[skillId]) {
          ...
          case SkillCategory.TMS:
            champ.unlockedTMs = champ.unlockedTMs || [];
            if (unlockId !== undefined && !champ.unlockedTMs.includes(unlockId)) {
              champ.unlockedTMs.push(unlockId);
            }
            break;
          case SkillCategory.XMS:
            champ.unlockedXMs = champ.unlockedXMs || [];
            if (unlockId !== undefined && !champ.unlockedXMs.includes(unlockId)) {
              champ.unlockedXMs.push(unlockId);
            }
            break;
          ...
          case SkillCategory.TRAINER_BOND_ABILITIES:
            champ.unlockedConditionalAbilities = champ.unlockedConditionalAbilities || [];
            if (unlockId !== undefined && !champ.unlockedConditionalAbilities.includes(unlockId)) {
              champ.unlockedConditionalAbilities.push(unlockId);
            }
            break;
          case SkillCategory.MEGA_STONES:
            champ.unlockedMegaStones = champ.unlockedMegaStones || [];
            if (unlockId !== undefined && !champ.unlockedMegaStones.includes(unlockId)) {
              champ.unlockedMegaStones.push(unlockId);
            }
            break;
          ...
          case SkillCategory.TYPE_SWITCHERS:
            champ.unlockedTypeSwitchers = champ.unlockedTypeSwitchers || [];
            if (unlockId !== undefined && !champ.unlockedTypeSwitchers.includes(unlockId)) {
              champ.unlockedTypeSwitchers.push(unlockId);
            }
            break;
          case SkillCategory.ESSENCE_BUNDLES:
            champ.unlockedEssenceBundles = champ.unlockedEssenceBundles || [];
            if (unlockId !== undefined && !champ.unlockedEssenceBundles.includes(unlockId)) {
              champ.unlockedEssenceBundles.push(unlockId);
            }
            break;
          case SkillCategory.PERMA_ITEMS:
            champ.unlockedPermaItems = champ.unlockedPermaItems || [];
            if (unlockId !== undefined && !champ.unlockedPermaItems.includes(unlockId)) {
              champ.unlockedPermaItems.push(unlockId);
            }
            break;
          case SkillCategory.STAT_BOOSTS:
            champ.unlockedStatBoosts = champ.unlockedStatBoosts || [];
            if (unlockId !== undefined && !champ.unlockedStatBoosts.includes(unlockId)) {
              champ.unlockedStatBoosts.push(unlockId);
            }
            break;
          case SkillCategory.MOVE_UPGRADES:
            champ.unlockedMoveUpgrades = champ.unlockedMoveUpgrades || [];
            if (unlockId !== undefined && !champ.unlockedMoveUpgrades.includes(unlockId)) {
              champ.unlockedMoveUpgrades.push(unlockId);
            }
            break;
          ...
          case SkillCategory.MOVE_UPGRADES_SPECIFIC:
            ...
            if (typeof unlockId === "string" && !champ.unlockedMoveAttrUpgrades.includes(unlockId)) {
              champ.unlockedMoveAttrUpgrades.push(unlockId);
            }
            break;
          case SkillCategory.TYPE_BOOSTERS:
            champ.unlockedTypeBoosters = champ.unlockedTypeBoosters || [];
            if (unlockId !== undefined && !champ.unlockedTypeBoosters.includes(unlockId)) {
              champ.unlockedTypeBoosters.push(unlockId);
            }
            break;
          case SkillCategory.VOUCHERS:
            champ.unlockedVoucherTiers = champ.unlockedVoucherTiers || [];
            if (unlockId !== undefined && !champ.unlockedVoucherTiers.includes(unlockId)) {
              champ.unlockedVoucherTiers.push(unlockId);
            }
            break;
          ...
          case SkillCategory.ESSENCE_TYPE_WEIGHTS:
            ...
            if (unlockId !== undefined && !champ.unlockedEssenceWeightTypes.includes(unlockId)) {
              champ.unlockedEssenceWeightTypes.push(unlockId);
            }
            break;
          case SkillCategory.TERA_TYPES:
          case SkillCategory.TERA_TYPE_REWARDS:
            champ.unlockedTeraTypes = champ.unlockedTeraTypes || [];
            if (unlockId !== undefined && !champ.unlockedTeraTypes.includes(unlockId)) {
              champ.unlockedTeraTypes.push(unlockId);
            }
            break;
          case SkillCategory.CATCHING:
            champ.unlockedCatchRateTypes = champ.unlockedCatchRateTypes || [];
            if (unlockId !== undefined && !champ.unlockedCatchRateTypes.includes(unlockId)) {
              champ.unlockedCatchRateTypes.push(unlockId);
            }
            break;
          ...
          case SkillCategory.FUSION_PRIORITIES: {
            try {
              ...
              if (unlockId && typeof unlockId === "object") {
                if ((unlockId as any).types) {
                  upd.types = (unlockId as any).types;
                }
                if ((unlockId as any).species) {
                  upd.species = (unlockId as any).species;
                }
              }
            ...
            try {
              if (typeof unlockId === "string") {
                ...
                if (key.includes("gold")) {
                  champ.unlockedGoldenPokeball = true;
                }
                if (key.includes("master")) {
                  champ.unlockedMasterBall = true;
                }
              }
            } catch {}
            break;
          ...
          case SkillCategory.POKEMON_ALT_BUILDS:
            champ.unlockedAltBuilds = champ.unlockedAltBuilds || [];
            if (unlockId !== undefined && !champ.unlockedAltBuilds.includes(unlockId)) {
              champ.unlockedAltBuilds.push(unlockId);
            }
            break;
          case SkillCategory.GLITCH_FORMS: {
            try {
              ...
              if (!questData || !questData.rewardId) {
                break;
              }
              const species = (allSpecies as any)?.[questData.rewardId - 1];
              if (!species) {
      ...
      try {
        ...
        if (Overrides.DEBUG_GRANT_ALL_ESSENCE) {
          ...
          for (const key of typeKeys) {
            ...
            if (typeValue < Type.NORMAL) {
              continue;
            }
            if (typeValue === Type.ALL) {
              continue;
            }
            let current = 0;
            try {
        ...
        if (k === "currentPermaShopOptions") {
          ...
          return v.map((option: any) => {
            ...
            if (modifierType instanceof QuestModifierTypeGenerator) {
              ...
              if (this.scene) {
                modifierType.assignScene(this.scene);
              }
              const GenModifierType = modifierType.generateType([], [0]);
              if (!GenModifierType.id) {
                GenModifierType.withIdFromFunc(modifierTypeFunc);
    ...
    return new Promise(async (resolve, reject) => {
      try {
        const initSessionFromData = async (_sessionData: SessionSaveData) => {
          ...
          const waveDebug = _sessionData.waveIndex;
          ...
          scene.getEnemyParty().forEach(enemy => {
            ...
            if ((enemy as any).is2ndStageBoss) {
              return;
            }
    ...
    return new Promise<boolean>(async (resolve) => {
      try {
        ...
        if (shouldSaveSessionData) {
          const serializedSessionData = this.serializeBigInt(sessionData);
  ...
  public getEssenceCount(type: Type): number {
    ...
    try {
      return perma.getTypeCount?.(type) || (perma.collectedTypes?.[type] || 0);
    } catch {
      return 0;
    }
  }
