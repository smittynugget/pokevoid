...
export enum SettingKeyboard {
    ...
    Button_Voidex = "BUTTON_VOIDEX",
    Alt_Button_Voidex = "ALT_BUTTON_VOIDEX",
    Button_Cycle_Fusion = "BUTTON_CYCLE_FUSION",
    Button_Smitty_Console = "BUTTON_CONSOLE",
    Alt_Button_Smitty_Console = "ALT_BUTTON_CONSOLE",
    Alt_Button_Cycle_Fusion = "ALT_BUTTON_CYCLE_FUSION",
...
export const settingKeyboardOptions = {
  ...
  [SettingKeyboard.Alt_Button_Cycle_Ability]: [`KEY ${Button.CYCLE_ABILITY.toString()}`, pressAction],
    ...
    [SettingKeyboard.Alt_Button_Smitty_Console]: [`KEY ${Button.CONSOLE.toString()}`, pressAction],
    [SettingKeyboard.Button_Voidex]: [`KEY ${Button.VOIDEX.toString()}`, pressAction],
    [SettingKeyboard.Alt_Button_Voidex]: [`KEY ${Button.VOIDEX.toString()}`, pressAction],
  ...
  [SettingKeyboard.Button_Cycle_Variant]: [`KEY ${Button.CYCLE_VARIANT.toString()}`, pressAction],
  [SettingKeyboard.Alt_Button_Cycle_Variant]: [`KEY ${Button.CYCLE_VARIANT.toString()}`, pressAction],
