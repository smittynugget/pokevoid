...
export class SkillTreeNodeGenerator {
  ...
  private isRewardEligibleForChampion(type: SkillTreeRewardType, c: PlayableChampionData): boolean {
    ...
    switch (type) {
      ...
      case SkillTreeRewardType.TRAINER_BOND_ABILITY: return (c.unlockedConditionalAbilities?.length ?? 0) > 0;
      ...
      case SkillTreeRewardType.SKILL_TREE_TOKENS:
        return true;
      case SkillTreeRewardType.TERA_ABILITY: return (c.unlockedConditionalAbilities?.length ?? 0) > 0;
