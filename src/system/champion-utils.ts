...
export class ChampionUtils {
  ...
  static getSignatureAltBuildId(species: Species, championData: PlayableChampionData): PokemonAltBuildId | null {
    ...
    console.log(`[ChampionUtils] getSignatureAltBuildId: championId=${championId}, species=${species}, result=${altBuildId}`);
    return altBuildId;
  }
  ...
  static attemptApplySignatureAltBuild(pokemon: Pokemon, championData: PlayableChampionData): PokemonAltBuildId | null {
    ...
    if (altBuild) {
      ...
      console.log(`[ChampionUtils] Applied Best Signature Alt Build ${bestBuildId} (Rank ${altBuild.rank}) to ${pokemon.species.name}`);
      return bestBuildId;
    }
