...
import {
    Type,
    getMinNightmareTypeValue,
    setNightmareTypeInteractions,
...
import { getModFormSystemName, modGlitchFormData } from "./mod-glitch-form-data";
import { getModPokemonName } from "./mod-glitch-form-utils";

function stripDuelmonArticles(name: string): string {
    return name.replace(/\b(?:the|of|is|in|a|an)\b/gi, "").replace(/\s{2,}/g, " ").trim();
}
...
const missingCryKeys: Set<string> = new Set<string>();

const ZA_MEGA_ICON_SPECIES_IDS: Set<Species> = new Set<Species>([
    Species.CLEFABLE,
    Species.VICTREEBEL,
    Species.STARMIE,
    Species.DRAGONITE,
...
const shouldFallbackZaMegaVariantSprite = (speciesId: Species, formSpriteKey: string, shiny?: boolean, variant?: integer) => {
    return !!shiny && (variant ?? 0) > 0 && formSpriteKey.startsWith(SpeciesFormKey.MEGA) && ZA_MEGA_ICON_SPECIES_IDS.has(speciesId);
};
export const DUELMON_SPRITE_BY_SPECIES: Readonly<Record<number, string>> = {
  [Species.ALIEN_MOTHER]: "alien_mother",
  [Species.ALLIGATORS_SWORD_DRAGON]: "alligator_s_sword_dragon",
  [Species.ANCIENT_GEAR_BOX]: "ancient_gear_box",
  [Species.ANCIENT_TREE_OF_ENLIGHTENMENT]: "ancient_tree_of_enlightenment",
  [Species.ARCANA_FORCE_I_THE_MAGICIAN]: "arcana_force_i_the_magician",
  [Species.ALPHA_THE_MAGNET_WARRIOR]: "alpha_the_magnet_warrior",
  [Species.ANCIENT_GEAR]: "ancient_gear",
  [Species.ANCIENT_GEAR_ENGINEER]: "ancient_gear_engineer",
  [Species.ANCIENT_GEAR_GOLEM]: "ancient_gear_golem",
  [Species.ANCIENT_GEAR_KNIGHT]: "ancient_gear_knight",
  [Species.ARCANA_FORCE_IV_THE_EMPEROR]: "arcana_force_iv_the_emperor",
  [Species.ARCANA_FORCE_XVIII_THE_MOON]: "arcana_force_xviii_the_moon",
  [Species.ARCANA_FORCE_VI_THE_LOVERS]: "arcana_force_vi_the_lovers",
  [Species.ARCANA_FORCE_EX_THE_DARK_RULER]: "arcana_force_ex_the_dark_ruler",
  [Species.ARCANA_FORCE_0_THE_FOOL]: "arcana_force_0_the_fool",
  [Species.ARCHFIEND_ZOMBIE]: "archfiend_zombie",
  [Species.ARMED_DRAGON_LV3]: "armed_dragon_lv3",
  [Species.ARMED_DRAGON_LV5]: "armed_dragon_lv5",
  [Species.ARMED_DRAGON_LV7]: "armed_dragon_lv7",
  [Species.AVATAR_OF_THE_POT]: "avatar_of_the_pot",
  [Species.AXE_RAIDER]: "axe_raider",
  [Species.BABY_DRAGON]: "baby_dragon",
  [Species.BEAN_SOLDIER]: "bean_soldier",
  [Species.BEAVER_WARRIOR]: "beaver_warrior",
  [Species.BEHEMOTH_THE_KING_OF_ALL_ANIMALS]: "behemoth_the_king_of_all_animals",
  [Species.BEIIGE_VANGUARD_OF_DARK_WORLD]: "beiige_vanguard_of_dark_world",
  [Species.ABAKI]: "abaki",
  [Species.ABARE_USHIONI]: "abare_ushioni",
  [Species.AGIDO]: "agido",
  [Species.AITSU]: "aitsu",
  [Species.ALIEN_GREY]: "alien_grey",
  [Species.ALIEN_MARS]: "alien_mars",
  [Species.BETA_THE_MAGNET_WARRIOR]: "beta_the_magnet_warrior",
  [Species.BICKURIBOX]: "bickuribox",
  [Species.BIG_JAWS]: "big_jaws",
  [Species.BIO_PLANT]: "bio_plant",
  [Species.BLACK_DRAGONS_CHICK]: "black_dragon_s_chick",
  [Species.BLACK_LUSTER_SOLDIER]: "black_luster_soldier",
  [Species.BLACK_LUSTER_SOLDIER_ENVOY_OF_THE_BEGINNING]: "black_luster_soldier_envoy_of_the_beginning",
  [Species.BLACK_MAGICIAN_OF_CHAOS]: "dark_magician_of_chaos",
  [Species.BLACK_TYRANNO]: "black_tyranno",
  [Species.BLADE_KNIGHT]: "blade_knight",
  [Species.BLAZING_INPACHI]: "blazing_inpachi",
  [Species.BLIZZARD_DRAGON]: "blizzarddragon",
  [Species.BLOWBACK_DRAGON]: "blowback_dragon",
  [Species.BLUE_EYES_ALTERNATIVE_WHITE_DRAGON]: "blue_eyes_alternative_white_dragon",
  [Species.BLUE_EYES_CHAOS_MAX_DRAGON]: "blue_eyes_chaos_max_dragon",
  [Species.BLUE_EYES_TOON_DRAGON_RENDER]: "blue_eyes_toon_dragon",
  [Species.BLUE_EYES_ULTIMATE_DRAGON]: "blue_eyes_ultimate_dragon",
  [Species.BLUE_EYES_WHITE_DRAGON]: "blue_eyes_white_dragon",
  [Species.BOO_KOO]: "boo_koo",
  [Species.BREAKER_THE_MAGICAL_WARRIOR]: "breaker_the_magical_warrrior",
  [Species.BUSTER_BLADER_DESTRUCTION_SWORDMASTER]: "buster_blader_the_destruction_swordmaster",
  [Species.CAIUS_THE_SHADOW_MONARCH]: "caius_the_shadow_monarch",
  [Species.CARD_TROOPER]: "card_trooper",
  [Species.CASTLE_OF_DARK_ILLUSIONS]: "castle_of_dark_illusions",
  [Species.CELTIC_GUARDIAN]: "celtic_guardian",
  [Species.CHAOS_EMPEROR_DRAGON_ENVOY_OF_THE_END]: "chaos_emperor_dragon_envoy_of_the_end",
  [Species.CLAW_REACHER]: "claw_reacher",
  [Species.CLOUDIAN_ACID_CLOUD]: "cloudian_acid_cloud",
  [Species.CLOUDIAN_EYE_OF_THE_TYPHOON]: "cloudian_eye_of_the_typhoon",
  [Species.CLOUDIAN_GHOST_FOG]: "cloudian_ghost_fog",
  [Species.CLOUDIAN_NIMBUSMAN]: "cloudian_nimbusman",
  [Species.CLOUDIAN_SMOKE_BALL]: "cloudian_smoke_ball",
  [Species.CLOUDIAN_STORM_DRAGON]: "cloudian_storm_dragon",
  [Species.COLOSSAL_FIGHTER]: "colossal_fighter1",
  [Species.COPYCAT]: "copycat",
  [Species.CRAB_TURTLE]: "crab_turtle",
  [Species.CRYSTAL_BEAST_AMBER_MAMMOTH]: "crystal_beast_amber_mammoth",
  [Species.CRYSTAL_BEAST_EMERALD_TORTOISE]: "crystal_beast_emerald_tortoise",
  [Species.CRYSTAL_BEAST_RUBY_CARBUNCLE]: "crystal_beast_ruby_carbuncle",
  [Species.CRYSTAL_BEAST_TOPAZ_TIGER]: "crystal_beast_topaz_tiger",
  [Species.CURSE_OF_DRAGON]: "curse_of_dragon",
  [Species.CURSE_OF_DRAGONFIRE]: "curse_of_dragonfire",
  [Species.CYBER_DINOSAUR]: "cyber_dinosaur",
  [Species.CYBER_END_DRAGON]: "cyber_end_dragon",
  [Species.CYBER_OGRE]: "cyber_ogre",
  [Species.CYBER_SAURUS]: "cyber_saurus",
  [Species.CYBER_TECH_ALLIGATOR]: "cyber_tech_alligator",
  [Species.CYBER_TWIN_DRAGON]: "cyber_twin_dragon",
  [Species.D_D_CRAZY_BEAST]: "d_d_crazy_beast",
  [Species.D_D_TRAINER]: "d_d_trainer",
  [Species.D_D_WARRIOR_LADY]: "d_d_warrior_lady",
  [Species.DANDYLION]: "dandylion",
  [Species.DANGER_BIGFOOT]: "danger_bigfoot",
  [Species.DARK_ERADICATOR_WARLOCK]: "dark_eradicator_warlock",
  [Species.DARK_EYES_ILLUSIONIST]: "dark_eyes_illusionist",
  [Species.DARK_MAGICIAN]: "dark_magician",
  [Species.DARK_MAGICIAN_VARIANT_2]: "dark_arkana_magician",
  [Species.DARK_MAGICIAN_GIRL_ALTERNATE]: "dark_magician_girl",
  [Species.DARK_NECROFEAR]: "dark_necrofear",
  [Species.DARK_PALADIN]: "dark_paladin",
  [Species.DARK_RESONATOR]: "dark_resonator",
  [Species.DARK_RABBIT]: "dark_rabbit",
  [Species.DARK_RULER_HA_DES]: "dark_ruler_ha_des",
  [Species.DARK_SAGE]: "dark_sage",
  [Species.DARK_WORLD_THORNS]: "dark_world_thorns",
  [Species.DARKFIRE_DRAGON]: "darkfire_dragon",
  [Species.DESPAIR_FROM_THE_DARK]: "despair_from_the_dark",
  [Species.DESTINY_HERO_DEFENDER]: "destiny_hero_defender",
  [Species.DESTINY_HERO_PLASMA]: "destiny_hero_plasma",
  [Species.DRAGON_DESTROYER_SWORDSMAN]: "dragon_destroyer_swordsman",
  [Species.DRAGON_SPIRIT_OF_WHITE]: "dragon_spirit_of_white",
  [Species.DRAGON_ZOMBIE]: "dragon_zombie",
  [Species.DRILLAGO]: "drillago",
  [Species.DUOTERION]: "duoterion",
  [Species.EARTHBOUND_IMMORTAL_CHACU_CHALLHUA]: "earthboundimmortal_chacu_challhua",
  [Species.EGYPTIAN_GOD_SLIME]: "egyptian_god_slime",
  [Species.ELEMENTAL_HERO_BLADEDGE]: "elemental_hero_bladedge",
  [Species.ELEMENTAL_HERO_BURSTINATRIX]: "elemental_hero_burstinatrix",
  [Species.ELEMENTAL_HERO_CLAYMAN]: "elemental_hero_clayman",
  [Species.ELEMENTAL_HERO_FLAME_WINGMAN]: "elemental_hero_flame_wingman",
  [Species.ELEMENTAL_HERO_NECROSHADE]: "elemental_hero_necroshade",
  [Species.ELEMENTAL_HERO_NEOS_ALT_MASTER_DUEL]: "elemental_hero_neos",
  [Species.ELEMENTAL_HERO_NEOS_ALIUS]: "elemental_hero_neos_alius",
  [Species.ELEMENTAL_HERO_SPARKMAN]: "elemental_hero_sparkman",
  [Species.ELEMENTAL_HERO_STRATOS]: "elemental_hero_stratos",
  [Species.ENRAGED_BATTLE_OX]: "enraged_battle_ox",
  [Species.EVILSWARM_MANDRAGORA]: "evilswarm_mandragora",
  [Species.EVILSWARM_SALAMANDRA]: "evilswarm_salamandra",
  [Species.EXODIA_FULL_BODY]: "exodia",
  [Species.EXODIA_NECROSS]: "exodia_necross",
  [Species.EXODIA_THE_FORBIDDEN_EVOLUTION]: "exodia_the_forbidden_evolution",
  [Species.EXODIUS_THE_ULTIMATE_FORBIDDEN_LORD]: "exodius_the_ultimate_forbidden_lord",
  [Species.FENRIR]: "fenrir",
  [Species.FERAL_IMP]: "feral_imp",
  [Species.FIEND_KRAKEN]: "fiend_kraken",
  [Species.FIEND_SWORD]: "fiend_sword",
  [Species.FOSSIL_DYNA_PACHYCEPHALO]: "fossil_dyna_pachycephalo",
  [Species.FOSSIL_WARRIOR_SKULL_KING]: "fossil_warrior_skull_king",
  [Species.FROST_FLAME_DRAGON]: "frost_and_flame_dragon",
  [Species.FROSTOSAURUS]: "frostosaurus",
  [Species.GAGAGIGO]: "gagagigo",
  [Species.GAIA_THE_DRAGON_CHAMPION]: "gaia_the_dragon_champion",
  [Species.GAIA_THE_FIERCE_KNIGHT]: "gaia_the_fierce_knight",
  [Species.GAMMA_THE_MAGNET_WARRIOR]: "gamma_the_magnet_warrior",
  [Species.GAZELLE_THE_KING_OF_MYTHICAL_BEASTS]: "gazelle_the_king_of_mythical_beasts",
  [Species.GELLENDUO]: "gellenduo",
  [Species.GEM_KNIGHT_CITRINE]: "gem_knight_citrine",
  [Species.GEM_KNIGHT_MASTER_DIAMOND]: "gem_knight_master_diamond",
  [Species.GENEX_ALLY_BIRDMAN]: "genex_ally_birdman",
  [Species.GHOSTRICK_GHOUL]: "ghostrick_ghoul",
  [Species.GHOSTRICK_MUMMY]: "ghostrick_mummy",
  [Species.GHOSTRICK_SKELETON]: "ghostrick_skeleton",
  [Species.GHOSTRICK_STEIN]: "ghostrick_stein",
  [Species.GHOSTRICK_YETI]: "ghostrick_yeti",
  [Species.GIGA_GAGAGIGO]: "giga_gagagigo",
  [Species.GATE_GUARDIAN]: "gate_guardian",
  [Species.GIGOBYTE]: "gigobyte",
  [Species.GOGIGA_GAGAGIGO]: "gogiga_gagagigo",
  [Species.GOLDEN_EYES_IDOL]: "golden_eyes_ido",
  [Species.GRAVEROBBER]: "graverobber",
  [Species.GREAT_MOTH]: "great_moth",
  [Species.GREAT_WHITE]: "great_white",
  [Species.GREEN_BABOON_DEFENDER_OF_THE_FOREST]: "green_baboon_defender_of_the_forest",
  [Species.GREEN_GADGET]: "green_gadget_alternate",
  [Species.GRIFFORE]: "griffore",
  [Species.GUARDIAN_GRARL]: "guardian_grarl",
  [Species.HADE_HANE]: "hade_hane",
  [Species.HANE_HANE]: "hane_hane",
  [Species.HARPIES_PET_DRAGON]: "harpie_s_pet_dragon",
  [Species.HEADLESS_KNIGHT]: "headless_knight",
  [Species.HITOTSU_ME_GIANT]: "hitotsu_me_giant",
  [Species.HUMANOID_SLIME]: "humanoid_slime",
  [Species.HUNDRED_EYES_DRAGON]: "hundred_eyes_dragon",
  [Species.HUNGRY_BURGER]: "hungry_burger",
  [Species.HYDROGEDDON]: "hydrogeddon",
  [Species.HYOZANRYU]: "hyozanryu",
  [Species.HYPER_HAMMERHEAD]: "hyper_hammerhead",
  [Species.ILLUSIONIST_FACELESS_MAGE]: "illusionist_faceless_mage",
  [Species.JINZO_THE_MACHINE_MENACE]: "jinzo",
  [Species.JUNK_WARRIOR]: "junk_warrior",
  [Species.KAZEJIN]: "kazejin",
  [Species.KING_OF_THE_SKULL_SERVANTS]: "king_of_the_skull_servants",
  [Species.KOITSU]: "koitsu",
  [Species.KOZAKY]: "kozaky",
  [Species.KURIBOH]: "kuriboh",
  [Species.LA_JINN_THE_MYSTICAL_GENIE]: "la_jinn_the_mystical_genie_of_the_lamp",
  [Species.LAVA_GOLEM]: "lava_golem",
  [Species.LEGENDARY_SWORDSMAN]: "legendary_swordsman",
  [Species.LEVIA_DRAGON_DAEDALUS]: "levia_dragon_daedalus",
  [Species.LORD_OF_D]: "lord_of_d",
  [Species.MAGICIANS_ROBE]: "magician_robe",
  [Species.MAGIKURIBOH]: "magikuriboh",
  [Species.MASKED_BEAST_DES_GARDIUS]: "masked_beast_des_gardius",
  [Species.MASTER_OF_OZ]: "master_of_oz",
  [Species.METEOR_B_DRAGON]: "meteor_b",
  [Species.MILLENNIUM_SCORPION]: "millennium_scorpion",
  [Species.MILLENNIUM_SHIELD]: "milennium_shield",
  [Species.MORPHING_JAR]: "morphing_jar",
  [Species.MUKA_MUKA]: "muka_muka",
  [Species.NUMBER_22_ZOMBIESTEIN]: "number_22_zombiestein",
  [Species.OBELISK_THE_TORMENTOR]: "obelisk_the_tormentor",
  [Species.OCEAN_DRAGON_LORD_KAIRYU_SHIN]: "ocean_dragon_lord_kairyu_shin",
  [Species.OJAMA_BLACK_GREEN]: "ojama_black",
  [Species.OJAMA_KING]: "ojama_king",
  [Species.OJAMA_KNIGHT]: "ojama_knight",
  [Species.OVERTEX_QOATLUS]: "overtex_qoatlus",
  [Species.OXYGEDDON]: "oxygeddon",
  [Species.PALADIN_OF_THE_CURSED_DRAGON]: "paladin_of_the_cursed_dragon",
  [Species.PALADIN_OF_WHITE_DRAGON]: "paladin_of_white_dragon",
  [Species.PANTHER_WARRIOR]: "panther_warrior",
  [Species.PANZER_DRAGON]: "panzer_dragon",
  [Species.PAPA_CORN]: "papa_corn",
  [Species.PLAGUESPREADER_ZOMBIE]: "plaguespreader_zombie",
  [Species.QUICKDRAW_SYNCHRON]: "quickdraw_synchron",
  [Species.RELINQUISHED]: "relinquished",
  [Species.SNOWMAN_EATER]: "snowman_eater",
  [Species.SOLDIER_OF_CHAOS]: "soldier_of_chaos",
  [Species.SOUL_HUNTER]: "soul_hunter",
  [Species.SPEED_WARRIOR]: "speed_warrior",
  [Species.STEEL_OGRE_GROTTO_1]: "steel_ogre_grotto",
  [Species.SUIJIN]: "suijin",
  [Species.YELLOW_GADGET]: "yellow_gear",
  [Species.SUPREME_KING_OF_ARMAGEDDON]: "supreme_king_of_armageddon",
  [Species.THE_CREATOR]: "the_creator",
  [Species.THE_FABLED_CERBURREL]: "the_fabled_cerurrel",
  [Species.THE_FABLED_GANASHIA]: "the_fabled_ganashia",
  [Species.THE_TRICKY]: "the_tricky",
  [Species.THE_MASKED_BEAST]: "the_masked_beast",
  [Species.THOUSAND_DRAGON]: "thousand_dragon",
  [Species.THOUSAND_EYES_RESTRICT]: "thousand_eyes_restrict",
  [Species.TIME_WIZARD_OF_TOMORROW]: "time_wizard_of_tomorrow",
  [Species.TOGEX]: "togex",
  [Species.YUBEL]: "yubel_the_loving_defender",
  [Species.ZOMBYRA_THE_DARK]: "zombyra_the_dark",
  [Species.WOODLAND_SPRITE]: "woodland_sprite",
  [Species.WATER_DRAGON]: "water_dragon",
  [Species.WATER_DRAGON_CLUSTER]: "water_dragon_cluster",
  [Species.VOLCANIC_SHELL]: "volcanic_shell",
  [Species.TOON_ALLIGATOR]: "toon_alligator",
  [Species.TOON_ANCIENT_GEAR_GOLEM]: "toon_ancient_gear_golem",
  [Species.TOON_BARREL_DRAGON]: "toon_barrel_dragon",
  [Species.TOON_BLACK_LUSTER_SOLDIER]: "toon_black_luster_soldier",
  [Species.TOON_DARK_MAGICIAN]: "toon_dark_magician",
  [Species.TOON_DARK_MAGICIAN_GIRL]: "toon_dark_magician_girl",
  [Species.TOON_MASKED_SORCERER]: "toon_masked_sorcerer",
  [Species.TOON_MERMAID]: "toon_mermaid",
  [Species.TOON_SUMMONED_SKULL]: "toon_summoned_skull",
  [Species.TWIN_HEADED_KING_REX]: "twin_headed_king_rex",
  [Species.ULTIMATE_ANCIENT_GEAR_GOLEM]: "ultimate_ancient_gear_golem",
  [Species.VALKYRION_THE_MAGNET_WARRIOR]: "valkerion_the_magnet_warrior",
  [Species.VOLCANIC_DOOMFIRE]: "volcanic_doomfire",
  [Species.VOLCANIC_ROCKET]: "volcanic_rocket",
  [Species.VOLCANIC_HAMMERER]: "volcanic_hammerer",
};
export const DUELMON_ICON_ATLAS_KEY = "pokemon_icons_yu";
export const DUELMON_ICON_ATLAS_FALLBACK_KEY = "pokemon_icons_glitch";
const DUELMON_SPRITE_FALLBACK = "alien_mother";

export const DUELMON_ICON_SCALE_OFFSET = -0.10;
export const GLITCH_SMITTY_ICON_SCALE_OFFSET = -0.10;

export function adjustDuelmonIconScale(baseScale: number, generation: number | undefined, isGlitchSmitty?: boolean): number {
  if (generation === 20) return Math.max(0.01, baseScale + DUELMON_ICON_SCALE_OFFSET);
  if (isGlitchSmitty) return Math.max(0.01, baseScale + GLITCH_SMITTY_ICON_SCALE_OFFSET);
  return baseScale;
}
...
export function getPokemonSpecies(species: Species | Species[] | undefined): PokemonSpecies {
    ...
    if (species >= 2000) {
        const found = allSpecies.find(s => s.speciesId === species);
        if (!found) {
            throw new Error(`Unknown speciesId ${species}`);
        }
        return found;
    }
...
export abstract class PokemonSpeciesForm {
    ...
    isObtainable(): boolean {
        return (this.generation <= 10 || this.generation === 20 || pokemonPrevolutions.hasOwnProperty(this.speciesId));
    }
    ...
    public isGlitchForm(formKey: string): boolean {
        ...
        return glitchFormValues.includes(formKey);
    }

    public isSmittyForm(formKey: string): boolean {
        const smittyFormValues = [
            SpeciesFormKey.SMITTY,
            SpeciesFormKey.SMITTY_B
        ];
        return smittyFormValues.includes(formKey);
    }

    public isGlitchOrSmittyForm(formKey: string): boolean {
        return this.isGlitchForm(formKey) || this.isSmittyForm(formKey);
    }
    ...
    private getGlitchOrSmittySpriteId(back?: boolean): string | null {
        if (this instanceof PokemonForm) {
            const formKey = this.getFormKey();
            if (this.isGlitchOrSmittyForm(formKey)) {
                const raw = this.formName.toLowerCase();
                const aliased = PokemonSpeciesForm.GLITCH_FORM_ASSET_ALIASES[raw] ?? raw;
                const spriteId = `glitch__${aliased}`;
                return back ? `${spriteId}_back` : spriteId;
            }
        }
        return null;
    }

    private getGlitchOrSmittyIconId(): string | null {
        if (this instanceof PokemonForm) {
            const formKey = this.getFormKey();
            if (this.isGlitchOrSmittyForm(formKey)) {
                const raw = this.formName.toLowerCase();
                return PokemonSpeciesForm.GLITCH_FORM_ASSET_ALIASES[raw] ?? raw;
            }
        }
        return null;
    }
    getSpriteId(female: boolean, formIndex?: integer, shiny?: boolean, variant: integer = 0, back?: boolean): string {
        ...
        const glitchSpriteId = this.getGlitchOrSmittySpriteId(back);
        if (glitchSpriteId) {
            return glitchSpriteId;
        }
        if (this.generation === 20) {
            const slug = DUELMON_SPRITE_BY_SPECIES[this.speciesId] ?? DUELMON_SPRITE_FALLBACK;
            return `yu__${slug}`;
        }
    ...
    getIconAtlasKey(formIndex?: integer, shiny?: boolean, variant?: integer): string {
        ...
        if (this instanceof PokemonForm) {
            const formKey = this.getFormKey();
            if (this.isGlitchOrSmittyForm(formKey)) {
                if (this.formName && formKey && isGlitchFormKey(formKey)) {
                    const systemName = getModFormSystemName(this.speciesId, this.formName);
                    const formData = modGlitchFormData[systemName];
                    if (formData && formData.sprites && formData.sprites.icon) {
                        return `pokemon_icons_mod_${this.formName.toLowerCase()}`;
                    }
                }
                return `pokemon_icons_glitch`;
            }
        }
        if (formSpriteKey.startsWith(SpeciesFormKey.MEGA) && ZA_MEGA_ICON_SPECIES_IDS.has(this.speciesId)) {
            return "pokemon_icons_za_1";
        }
    ...
    getIconId(female: boolean, formIndex?: integer, shiny?: boolean, variant?: integer): string {
        ...
        if (this.generation === 20) {
            return DUELMON_SPRITE_BY_SPECIES[this.speciesId] ?? DUELMON_SPRITE_FALLBACK;
        }
        const glitchIconId = this.getGlitchOrSmittyIconId();
        if (glitchIconId) {
            return glitchIconId;
        }
        ...
        const showGenderDiffs = female && !formSpriteKey.startsWith(SpeciesFormKey.MEGA) && !formSpriteKey.startsWith(SpeciesFormKey.GIGANTAMAX);
    ...
    getCryKey(formIndex?: integer): string {
        if (this.generation === 20) {
            const duelmonIndex = this.speciesId - Species.ALIEN_MOTHER + 1;
            if (duelmonIndex >= 1 && duelmonIndex <= 245) {
                return duelmonIndex.toString();
            }
            return "1";
        }
        let speciesId = this.speciesId;

        if (this.speciesId > 2000 && this.speciesId < 9999990) {
            switch (this.speciesId) {
    ...
    loadAssets(scene: BattleScene, female: boolean, formIndex?: integer, shiny?: boolean, variant?: Variant, startLoad?: boolean): Promise<void> {
        return new Promise(resolve => {
            ...
            const fallbackCryKey = this.getCryKey(0);
            const cryCacheKey = `cry/${cryKey}`;
            if (cryKey !== fallbackCryKey && missingCryKeys.has(cryKey)) {
                scene.load.audio(cryCacheKey, `audio/cry/${fallbackCryKey}.m4a`);
            } else {
                scene.load.audio(cryCacheKey, `audio/cry/${cryKey}.m4a`);
            }
            let cryLoadErrorListenerAdded = false;
            let queuedCryFallback = false;
            const onCryLoadError = (file: any) => {
                if (queuedCryFallback || cryKey === fallbackCryKey) {
                    return;
                }
                if (file?.key !== cryCacheKey) {
                    return;
                }
                queuedCryFallback = true;
                missingCryKeys.add(cryKey);
                scene.load.audio(cryCacheKey, `audio/cry/${fallbackCryKey}.m4a`);
            };
            if (cryKey !== fallbackCryKey && !missingCryKeys.has(cryKey)) {
                scene.load.on(Phaser.Loader.Events.FILE_LOAD_ERROR, onCryLoadError);
                cryLoadErrorListenerAdded = true;
            }
            scene.load.once(Phaser.Loader.Events.COMPLETE, () => {
                if (cryLoadErrorListenerAdded) {
                    scene.load.off(Phaser.Loader.Events.FILE_LOAD_ERROR, onCryLoadError);
                }
                ...
                if (!(scene.anims.exists(spriteKey))) {
                    if (frameNames.length) {
                        ...
                        const tex = scene.textures.exists(spriteKey) ? scene.textures.get(spriteKey) : null;
                        const firstFrameName = tex ? tex.getFrameNames()[0] : null;
                        scene.anims.create({
                            key: this.getSpriteKey(female, formIndex, shiny, variant),
                            frames: firstFrameName ? [{ key: spriteKey, frame: firstFrameName }] : [{ key: spriteKey }],
                            frameRate: 1,
                            repeat: -1
                        });
                    }
...
export default class PokemonSpecies extends PokemonSpeciesForm implements Localizable {
    ...
    public obtainedFusionSpecies: Species[];
    public fusionIndex: integer;
        ...
        if (formIndex !== undefined && this.forms.length) {
            ...
            if (this.isGlitchForm(form.formKey)) {
                ...
                if (modGlitchFormData[systemName]) {
                    ...
                    return form.formName.charAt(0).toUpperCase() + form.formName.slice(1).toLowerCase();
                }

                return i18next.t(`glitchNames:${form.formName.toLowerCase()}.name`);
            }

            if (this.isSmittyForm(form.formKey)) {
                return i18next.t(`smittyNames:${form.formName}.name`);
            }
    ...
    localize(): void {
        if (Species[this.speciesId] == undefined) {
            console.log('species not found', this.speciesId);
        }
        if (this.generation === 20) {
            const slug = DUELMON_SPRITE_BY_SPECIES[this.speciesId];
            if (slug && i18next.exists(`duelmonNames:${slug}.name`)) {
                const langData = i18next.getDataByLanguage(i18next.resolvedLanguage || i18next.language) as any;
                const entry = langData?.duelmonNames?.[slug];
                const raw = entry?.name || i18next.t(`duelmonNames:${slug}.name`);
                const skip = entry?.skipStrip === true || entry?.skipStrip === "true";
                this.name = skip ? raw : stripDuelmonArticles(raw);
                return;
            }
            const fallback = i18next.t(`pokemon:${Species[this.speciesId].toLowerCase()}`);
            this.name = stripDuelmonArticles(fallback);
            return;
        }
    ...
    getWildSpeciesForLevel(level: integer, allowEvolving: boolean, isBoss: boolean, gameMode: GameMode): Species {
        return this.getSpeciesForLevel(level, allowEvolving, false, (isBoss ? PartyMemberStrength.WEAKER : PartyMemberStrength.AVERAGE) + (gameMode?.isEndless ? 1 : 0), gameMode?.isNightmare);
    }

    getTrainerSpeciesForLevel(level: integer, allowEvolving: boolean = false, strength: PartyMemberStrength, currentWave: number = 0, isNightmare: boolean = false): Species {
        return this.getSpeciesForLevel(level, allowEvolving, true, strength, currentWave, isNightmare);
    }
    ...
    getSpeciesForLevel(level: integer, allowEvolving: boolean = false, forTrainer: boolean = false, strength: PartyMemberStrength = PartyMemberStrength.WEAKER, currentWave: number = 0, isNightmare: boolean = false): Species {
        if (isNightmare) {
            currentWave = currentWave % 100;
            currentWave = currentWave === 0 ? 100 : currentWave;
        }
        ...
        for (const ev of evolutions) {
            ...
            if (currentWave >= 50 && forTrainer && strength > PartyMemberStrength.WEAKER) {
                evolutionChance = 1;
                noEvolutionChance = 0;
            }
        ...
        for (const weight of evolutionPool.keys()) {
            if (randValue < weight) {
                return getPokemonSpecies(evolutionPool.get(weight)).getSpeciesForLevel(level, true, forTrainer, strength, currentWave, isNightmare);
            }
        }
    ...
    isLegendSubOrMystical() {
        return this.legendary || this.subLegendary || this.mythical;
    }
    ...
    getGlitchFormName(getGlitchFormName: boolean = false, scene?: BattleScene, rewardType: RewardType = RewardType.GLITCH_FORM_A): string | null {
        const rewardTypeToFormKeyMap = {
        ...
        const targetFormKey = rewardTypeToFormKeyMap[rewardType];
        ...
        for (const evolution of evolutions) {
            ...
            const glitchFormName = evolutionSpecies.getGlitchFormName(getGlitchFormName, scene, rewardType);
            if (glitchFormName) {
                return glitchFormName;
            }
        }
...
export function isGlitchFormKey(formKey: string): boolean {
    return formKey.includes("glitch");
}

export function isSmittyFormKey(formKey: string): boolean {
    return formKey.includes("smitty");
}
...
export class PokemonForm extends PokemonSpeciesForm {
    ...
    public static addUniversalSmittyForm(pokemon: Pokemon, universalForm: UniversalSmittyForm, loadedFromData: boolean = false, limitForms: boolean = false): PokemonForm {
        const originalSpecies = pokemon.species;
        const species = pokemon.makeSpeciesUnique();
        if(limitForms) {
            species.forms = [];
        }
        const isSpecialForm = ["smitshade", "smitspect", "smitwraith", "smiternal"].includes(universalForm.formName) && !loadedFromData;

        const localForm = {...universalForm};
        ...
        const baseForm = pokemon.getSpeciesForm();
        localForm.primaryType = universalForm.primaryType !== null ? universalForm.primaryType : baseForm.type1;
        const potentialSecondaryTypes = [
            baseForm.type2,
            universalForm.secondaryType,
            baseForm.type1
        ].filter(t => t !== null);

        let secondaryType = potentialSecondaryTypes.find(t => t !== localForm.primaryType);

        if (!secondaryType || secondaryType === localForm.primaryType) {
            const possibleTypes = Array.from({length: Type.STELLAR - Type.NORMAL + 1}, (_, i) => Type.NORMAL + i)
                .filter(type => type !== localForm.primaryType);
            secondaryType = possibleTypes[Utils.randSeedInt(possibleTypes.length)];
        }

        localForm.secondaryType = secondaryType;
        if (isSpecialForm) {
            const allAbilitiesList = Object.values(Abilities)
                .filter(ability => typeof ability === 'number') as Abilities[];

            localForm.ability1 = allAbilitiesList[Utils.randSeedInt(allAbilitiesList.length)];
            localForm.ability2 = allAbilitiesList[Utils.randSeedInt(allAbilitiesList.length)];
            localForm.abilityHidden = allAbilitiesList[Utils.randSeedInt(allAbilitiesList.length)];

            localForm.primaryType = baseForm.type1;
            const possibleTypes = Array.from({length: Type.STELLAR - Type.NORMAL + 1}, (_, i) => Type.NORMAL + i)
                .filter(type => type !== localForm.primaryType);

            localForm.secondaryType = possibleTypes[Utils.randSeedInt(possibleTypes.length)];
        }

        const newForm = new PokemonForm(
            localForm.formName,
            localForm.formKey,
            localForm.primaryType,
            localForm.secondaryType,
            baseForm.height,
            baseForm.weight,
            localForm.ability1,
            localForm.ability2,
            localForm.abilityHidden,
            localForm.totalStats,
            localForm.hp,
            localForm.attack,
            localForm.defense,
            localForm.spAttack,
            ...
            localForm.speed,
            baseForm.catchRate,
            baseForm.baseFriendship,
            baseForm.baseExp,
            baseForm.genderDiffs,
            null,
            false
        );
        ...
        pokemon.universalSmittyForm = localForm;
...
export interface UniversalSmittyForm {
    formName: string;
    ...
    spDefense: number;
    speed: number;
    requiredItems: FormChangeItem[];
}

export const universalSmittyForms: UniversalSmittyForm[] = [];
export const pokemonSmittyForms: Map<Species, PokemonForm[]> = new Map();
...
export function initSpecies() {
    allSpecies.push(
        ...
        new PokemonSpecies(Species.PIKACHU, 1, false, false, false, "Mouse Pokémon", Type.ELECTRIC, null, 0.4, 6, Abilities.STATIC, Abilities.NONE, Abilities.LIGHTNING_ROD, 320, 35, 55, 40, 50, 50, 90, 190, 50, 112, GrowthRate.MEDIUM_FAST, 50, true, true,
            ...
            new PokemonForm("G-Max", SpeciesFormKey.GIGANTAMAX, Type.ELECTRIC, null, 21, 6, Abilities.LIGHTNING_ROD, Abilities.LIGHTNING_ROD, Abilities.LIGHTNING_ROD, 530, 125, 95, 60, 90, 70, 90, 190, 50, 112),
        ),
        new PokemonSpecies(Species.RAICHU, 1, false, false, false, "Mouse Pokémon", Type.ELECTRIC, null, 0.8, 30, Abilities.STATIC, Abilities.NONE, Abilities.LIGHTNING_ROD, 485, 60, 90, 55, 90, 80, 110, 75, 50, 243, GrowthRate.MEDIUM_FAST, 50, true, true,
            new PokemonForm("Normal", "", Type.ELECTRIC, null, 0.8, 30, Abilities.STATIC, Abilities.NONE, Abilities.LIGHTNING_ROD, 485, 60, 90, 55, 90, 80, 110, 75, 50, 243, true, null, true),
            new PokemonForm("Mega X", SpeciesFormKey.MEGA_X, Type.ELECTRIC, null, 0.8, 30, Abilities.ELECTRIC_SURGE, Abilities.ELECTRIC_SURGE, Abilities.LIGHTNING_ROD, 585, 60, 135, 95, 90, 95, 110, 75, 50, 243, true),
            new PokemonForm("Mega Y", SpeciesFormKey.MEGA_Y, Type.ELECTRIC, null, 0.8, 30, Abilities.ADAPTABILITY, Abilities.ADAPTABILITY, Abilities.LIGHTNING_ROD, 585, 60, 100, 55, 160, 80, 130, 75, 50, 243, true),
        ),
        ...
        new PokemonSpecies(Species.CLEFABLE, 1, false, false, false, "Fairy Pokémon", Type.FAIRY, null, 1.3, 40, Abilities.CUTE_CHARM, Abilities.MAGIC_GUARD, Abilities.UNAWARE, 483, 95, 70, 73, 95, 90, 60, 25, 140, 242, GrowthRate.FAST, 25, false, true,
            new PokemonForm("Normal", "", Type.FAIRY, null, 1.3, 40, Abilities.CUTE_CHARM, Abilities.MAGIC_GUARD, Abilities.UNAWARE, 483, 95, 70, 73, 95, 90, 60, 25, 140, 242, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.FAIRY, Type.FLYING, 1.5, 50, Abilities.MAGIC_BOUNCE, Abilities.MAGIC_BOUNCE, Abilities.PIXILATE, 583, 95, 80, 93, 135, 110, 70, 25, 140, 242, false),
        ),
        ...
        new PokemonSpecies(Species.VICTREEBEL, 1, false, false, false, "Flycatcher Pokémon", Type.GRASS, Type.POISON, 1.7, 15.5, Abilities.CHLOROPHYLL, Abilities.NONE, Abilities.GLUTTONY, 490, 80, 105, 65, 100, 70, 70, 45, 70, 221, GrowthRate.MEDIUM_SLOW, 50, false, true,
            new PokemonForm("Normal", "", Type.GRASS, Type.POISON, 1.7, 15.5, Abilities.CHLOROPHYLL, Abilities.NONE, Abilities.GLUTTONY, 490, 80, 105, 65, 100, 70, 70, 45, 70, 221, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.GRASS, Type.POISON, 2.0, 20, Abilities.INNARDS_OUT, Abilities.INNARDS_OUT, Abilities.HARVEST, 590, 80, 125, 85, 135, 95, 70, 45, 70, 221, false),
        ),
        ...
        new PokemonSpecies(Species.STARMIE, 1, false, false, false, "Mysterious Pokémon", Type.WATER, Type.PSYCHIC, 1.1, 80, Abilities.ILLUMINATE, Abilities.NATURAL_CURE, Abilities.ANALYTIC, 520, 60, 75, 85, 100, 85, 115, 60, 50, 182, GrowthRate.SLOW, null, false, true,
            new PokemonForm("Normal", "", Type.WATER, Type.PSYCHIC, 1.1, 80, Abilities.ILLUMINATE, Abilities.NATURAL_CURE, Abilities.ANALYTIC, 520, 60, 75, 85, 100, 85, 115, 60, 50, 182, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.WATER, Type.PSYCHIC, 1.3, 100, Abilities.HUGE_POWER, Abilities.HUGE_POWER, Abilities.PSYCHIC_SURGE, 660, 60, 140, 105, 130, 105, 120, 60, 50, 182, false),
        ),
        ...
        new PokemonSpecies(Species.EEVEE, 1, false, false, false, "Evolution Pokémon", Type.NORMAL, null, 0.3, 6.5, Abilities.RUN_AWAY, Abilities.ADAPTABILITY, Abilities.ANTICIPATION, 325, 55, 55, 50, 45, 65, 55, 45, 50, 65, GrowthRate.MEDIUM_FAST, 87.5, false, true,
            ...
            new PokemonForm("G-Max", SpeciesFormKey.GIGANTAMAX, Type.NORMAL, null, 18, 6.5, Abilities.PROTEAN, Abilities.PROTEAN, Abilities.PROTEAN, 535, 105, 95, 70, 95, 85, 85, 45, 50, 65),
        ),
        ...
        new PokemonSpecies(Species.DRAGONITE, 1, false, false, false, "Dragon Pokémon", Type.DRAGON, Type.FLYING, 2.2, 210, Abilities.INNER_FOCUS, Abilities.NONE, Abilities.MULTISCALE, 600, 91, 134, 95, 100, 100, 80, 45, 35, 300, GrowthRate.SLOW, 50, false, true,
            new PokemonForm("Normal", "", Type.DRAGON, Type.FLYING, 2.2, 210, Abilities.INNER_FOCUS, Abilities.NONE, Abilities.MULTISCALE, 600, 91, 134, 95, 100, 100, 80, 45, 35, 300, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.DRAGON, Type.FLYING, 2.5, 250, Abilities.MULTISCALE, Abilities.MULTISCALE, Abilities.MARVEL_SCALE, 700, 91, 124, 115, 145, 125, 100, 45, 35, 300, false),
        ),
        ...
        new PokemonSpecies(Species.MEGANIUM, 2, false, false, false, "Herb Pokémon", Type.GRASS, null, 1.8, 100.5, Abilities.OVERGROW, Abilities.NONE, Abilities.LEAF_GUARD, 525, 80, 82, 100, 83, 100, 80, 45, 70, 236, GrowthRate.MEDIUM_SLOW, 87.5, true, true,
            new PokemonForm("Normal", "", Type.GRASS, null, 1.8, 100.5, Abilities.OVERGROW, Abilities.NONE, Abilities.LEAF_GUARD, 525, 80, 82, 100, 83, 100, 80, 45, 70, 236, true, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.GRASS, Type.FAIRY, 2.0, 120, Abilities.MEGA_SOL, Abilities.MEGA_SOL, Abilities.REGENERATOR, 625, 80, 92, 115, 143, 115, 80, 45, 70, 236, true),
        ),
        ...
        new PokemonSpecies(Species.FERALIGATR, 2, false, false, false, "Big Jaw Pokémon", Type.WATER, null, 2.3, 88.8, Abilities.TORRENT, Abilities.NONE, Abilities.SHEER_FORCE, 530, 85, 105, 100, 79, 83, 78, 45, 70, 239, GrowthRate.MEDIUM_SLOW, 87.5, false, true,
            new PokemonForm("Normal", "", Type.WATER, null, 2.3, 88.8, Abilities.TORRENT, Abilities.NONE, Abilities.SHEER_FORCE, 530, 85, 105, 100, 79, 83, 78, 45, 70, 239, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.WATER, Type.DRAGON, 2.6, 110, Abilities.DRAGONIZE, Abilities.DRAGONIZE, Abilities.STRONG_JAW, 630, 85, 160, 125, 89, 93, 78, 45, 70, 239, false),
        ),
        ...
        new PokemonSpecies(Species.SKARMORY, 2, false, false, false, "Armor Bird Pokémon", Type.STEEL, Type.FLYING, 1.7, 50.5, Abilities.KEEN_EYE, Abilities.STURDY, Abilities.WEAK_ARMOR, 465, 65, 80, 140, 40, 70, 70, 25, 50, 163, GrowthRate.SLOW, 50, false, true,
            new PokemonForm("Normal", "", Type.STEEL, Type.FLYING, 1.7, 50.5, Abilities.KEEN_EYE, Abilities.STURDY, Abilities.WEAK_ARMOR, 465, 65, 80, 140, 40, 70, 70, 25, 50, 163, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.STEEL, Type.FLYING, 2.0, 65, Abilities.STALWART, Abilities.STALWART, Abilities.TOUGH_CLAWS, 565, 65, 140, 110, 40, 100, 110, 25, 50, 163, false),
        ),
        ...
        new PokemonSpecies(Species.SLAKOTH, 3, false, false, false, "Slacker Pokémon", Type.NORMAL, null, 0.8, 24, Abilities.TRUANT, Abilities.NONE, Abilities.STALL, 280, 60, 60, 60, 35, 35, 30, 255, 70, 56, GrowthRate.SLOW, 50, false),
        new PokemonSpecies(Species.VIGOROTH, 3, false, false, false, "Wild Monkey Pokémon", Type.NORMAL, null, 1.4, 46.5, Abilities.VITAL_SPIRIT, Abilities.NONE, Abilities.INSOMNIA, 440, 80, 80, 80, 55, 55, 90, 120, 70, 154, GrowthRate.SLOW, 50, false),
        new PokemonSpecies(Species.SLAKING, 3, false, false, false, "Lazy Pokémon", Type.NORMAL, null, 2, 130.5, Abilities.TRUANT, Abilities.NONE, Abilities.STALL, 670, 150, 160, 100, 95, 65, 100, 45, 70, 252, GrowthRate.SLOW, 50, false),
        ...
        new PokemonSpecies(Species.CHIMECHO, 3, false, false, false, "Wind Chime Pokémon", Type.PSYCHIC, null, 0.6, 1, Abilities.LEVITATE, Abilities.NONE, Abilities.NONE, 455, 75, 50, 80, 95, 90, 65, 45, 70, 159, GrowthRate.FAST, 50, false, true,
            new PokemonForm("Normal", "", Type.PSYCHIC, null, 0.6, 1, Abilities.LEVITATE, Abilities.NONE, Abilities.NONE, 455, 75, 50, 80, 95, 90, 65, 45, 70, 159, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.PSYCHIC, Type.STEEL, 0.6, 1, Abilities.LEVITATE, Abilities.LEVITATE, Abilities.NONE, 555, 75, 50, 110, 135, 120, 65, 45, 70, 159, false),
        ),
        new PokemonSpecies(Species.ABSOL, 3, false, false, false, "Disaster Pokémon", Type.DARK, null, 1.2, 47, Abilities.PRESSURE, Abilities.SUPER_LUCK, Abilities.JUSTIFIED, 465, 65, 130, 60, 75, 60, 75, 30, 35, 163, GrowthRate.MEDIUM_SLOW, 50, false, true,
            ...
            new PokemonForm("Mega Z", SpeciesFormKey.MEGA_Z, Type.DARK, Type.GHOST, 1.2, 49, Abilities.SHADOW_SHIELD, Abilities.SHADOW_SHIELD, Abilities.MAGIC_BOUNCE, 565, 65, 154, 60, 75, 60, 151, 30, 35, 163),
        ),
        ...
        new PokemonSpecies(Species.STARAPTOR, 4, false, false, false, "Predator Pokémon", Type.NORMAL, Type.FLYING, 1.2, 24.9, Abilities.INTIMIDATE, Abilities.NONE, Abilities.RECKLESS, 485, 85, 120, 70, 50, 60, 100, 45, 70, 218, GrowthRate.MEDIUM_SLOW, 50, true, true,
            new PokemonForm("Normal", "", Type.NORMAL, Type.FLYING, 1.2, 24.9, Abilities.INTIMIDATE, Abilities.NONE, Abilities.RECKLESS, 485, 85, 120, 70, 50, 60, 100, 45, 70, 218, true, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.FLYING, Type.FIGHTING, 1.2, 24.9, Abilities.CONTRARY, Abilities.CONTRARY, Abilities.RECKLESS, 585, 85, 140, 100, 60, 90, 110, 45, 70, 218, true),
        ),
        ...
        new PokemonSpecies(Species.GARCHOMP, 4, false, false, false, "Mach Pokémon", Type.DRAGON, Type.GROUND, 1.9, 95, Abilities.SAND_VEIL, Abilities.NONE, Abilities.ROUGH_SKIN, 600, 108, 130, 95, 80, 85, 102, 45, 50, 300, GrowthRate.SLOW, 50, true, true,
            ...
            new PokemonForm("Mega Z", SpeciesFormKey.MEGA_Z, Type.DRAGON, null, 1.9, 95, Abilities.DRAGONS_MAW, Abilities.DRAGONS_MAW, Abilities.ROUGH_SKIN, 700, 108, 130, 85, 141, 85, 151, 45, 50, 300, true),
        ),
        ...
        new PokemonSpecies(Species.LUCARIO, 4, false, false, false, "Aura Pokémon", Type.FIGHTING, Type.STEEL, 1.2, 54, Abilities.STEADFAST, Abilities.INNER_FOCUS, Abilities.JUSTIFIED, 525, 70, 110, 70, 115, 70, 90, 45, 50, 184, GrowthRate.MEDIUM_SLOW, 87.5, false, true,
            ...
            new PokemonForm("Mega Z", SpeciesFormKey.MEGA_Z, Type.FIGHTING, Type.STEEL, 1.3, 57.5, Abilities.PRANKSTER, Abilities.PRANKSTER, Abilities.JUSTIFIED, 625, 70, 100, 70, 164, 70, 151, 45, 50, 184),
        ),
        ...
        new PokemonSpecies(Species.FROSLASS, 4, false, false, false, "Snow Land Pokémon", Type.ICE, Type.GHOST, 1.3, 26.6, Abilities.SNOW_CLOAK, Abilities.NONE, Abilities.CURSED_BODY, 480, 70, 80, 70, 80, 70, 110, 75, 50, 168, GrowthRate.MEDIUM_FAST, 0, false, true,
            new PokemonForm("Normal", "", Type.ICE, Type.GHOST, 1.3, 26.6, Abilities.SNOW_CLOAK, Abilities.NONE, Abilities.CURSED_BODY, 480, 70, 80, 70, 80, 70, 110, 75, 50, 168, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.ICE, Type.GHOST, 1.5, 35, Abilities.SNOW_WARNING, Abilities.SNOW_WARNING, Abilities.REFRIGERATE, 580, 70, 80, 70, 140, 100, 120, 75, 50, 168, false),
        ),
        ...
        new PokemonSpecies(Species.HEATRAN, 4, true, false, false, "Lava Dome Pokémon", Type.FIRE, Type.STEEL, 1.7, 430, Abilities.FLASH_FIRE, Abilities.NONE, Abilities.FLAME_BODY, 600, 91, 90, 106, 130, 106, 77, 3, 100, 300, GrowthRate.SLOW, 50, false, true,
            new PokemonForm("Normal", "", Type.FIRE, Type.STEEL, 1.7, 430, Abilities.FLASH_FIRE, Abilities.NONE, Abilities.FLAME_BODY, 600, 91, 90, 106, 130, 106, 77, 3, 100, 300, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.FIRE, Type.STEEL, 1.7, 430, Abilities.MAGNET_PULL, Abilities.MAGNET_PULL, Abilities.FLAME_BODY, 700, 91, 120, 106, 175, 141, 67, 3, 100, 300, false),
        ),
        ...
        new PokemonSpecies(Species.DARKRAI, 4, false, false, true, "Pitch-Black Pokémon", Type.DARK, null, 1.5, 50.5, Abilities.BAD_DREAMS, Abilities.NONE, Abilities.NONE, 600, 70, 90, 90, 135, 90, 125, 3, 0, 270, GrowthRate.SLOW, null, false, true,
            new PokemonForm("Normal", "", Type.DARK, null, 1.5, 50.5, Abilities.BAD_DREAMS, Abilities.NONE, Abilities.NONE, 600, 70, 90, 90, 135, 90, 125, 3, 0, 270, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.DARK, null, 1.5, 50.5, Abilities.NIGHTMARES, Abilities.NIGHTMARES, Abilities.BAD_DREAMS, 700, 70, 120, 130, 165, 130, 85, 3, 0, 270, false),
        ),
        ...
        new PokemonSpecies(Species.EMBOAR, 5, false, false, false, "Mega Fire Pig Pokémon", Type.FIRE, Type.FIGHTING, 1.6, 150, Abilities.BLAZE, Abilities.NONE, Abilities.RECKLESS, 528, 110, 123, 65, 100, 65, 65, 45, 70, 238, GrowthRate.MEDIUM_SLOW, 87.5, false, true,
            new PokemonForm("Normal", "", Type.FIRE, Type.FIGHTING, 1.6, 150, Abilities.BLAZE, Abilities.NONE, Abilities.RECKLESS, 528, 110, 123, 65, 100, 65, 65, 45, 70, 238, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.FIRE, Type.FIGHTING, 1.9, 180, Abilities.MOLD_BREAKER, Abilities.MOLD_BREAKER, Abilities.RECKLESS, 628, 110, 148, 75, 110, 110, 75, 45, 70, 238, false),
        ),
        ...
        new PokemonSpecies(Species.EXCADRILL, 5, false, false, false, "Subterrene Pokémon", Type.GROUND, Type.STEEL, 0.7, 40.4, Abilities.SAND_RUSH, Abilities.SAND_FORCE, Abilities.MOLD_BREAKER, 508, 110, 135, 60, 50, 65, 88, 60, 50, 178, GrowthRate.MEDIUM_FAST, 50, false, true,
            new PokemonForm("Normal", "", Type.GROUND, Type.STEEL, 0.7, 40.4, Abilities.SAND_RUSH, Abilities.SAND_FORCE, Abilities.MOLD_BREAKER, 508, 110, 135, 60, 50, 65, 88, 60, 50, 178, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.GROUND, Type.STEEL, 1.0, 55, Abilities.PIERCING_DRILL, Abilities.PIERCING_DRILL, Abilities.EARTH_EATER, 608, 110, 165, 100, 65, 65, 103, 60, 50, 178, false),
        ),
        ...
        new PokemonSpecies(Species.SCOLIPEDE, 5, false, false, false, "Megapede Pokémon", Type.BUG, Type.POISON, 2.5, 200.5, Abilities.POISON_POINT, Abilities.SWARM, Abilities.SPEED_BOOST, 485, 60, 100, 89, 55, 69, 112, 45, 50, 243, GrowthRate.MEDIUM_SLOW, 50, false, true,
            new PokemonForm("Normal", "", Type.BUG, Type.POISON, 2.5, 200.5, Abilities.POISON_POINT, Abilities.SWARM, Abilities.SPEED_BOOST, 485, 60, 100, 89, 55, 69, 112, 45, 50, 243, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.BUG, Type.POISON, 3.0, 250, Abilities.STAMINA, Abilities.STAMINA, Abilities.SPEED_BOOST, 585, 60, 140, 149, 75, 99, 62, 45, 50, 243, false),
        ),
        ...
        new PokemonSpecies(Species.SCRAFTY, 5, false, false, false, "Hoodlum Pokémon", Type.DARK, Type.FIGHTING, 1.1, 30, Abilities.SHED_SKIN, Abilities.MOXIE, Abilities.INTIMIDATE, 488, 65, 90, 115, 45, 115, 58, 90, 50, 171, GrowthRate.MEDIUM_FAST, 50, false, true,
            new PokemonForm("Normal", "", Type.DARK, Type.FIGHTING, 1.1, 30, Abilities.SHED_SKIN, Abilities.MOXIE, Abilities.INTIMIDATE, 488, 65, 90, 115, 45, 115, 58, 90, 50, 171, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.DARK, Type.FIGHTING, 1.3, 40, Abilities.COTTON_DOWN, Abilities.COTTON_DOWN, Abilities.INTIMIDATE, 588, 65, 130, 135, 55, 135, 68, 90, 50, 171, false),
        ),
        ...
        new PokemonSpecies(Species.ARCHEN, 5, false, false, false, "First Bird Pokémon", Type.ROCK, Type.FLYING, 0.5, 9.5, Abilities.DEFEATIST, Abilities.NONE, Abilities.EMERGENCY_EXIT, 401, 55, 112, 45, 74, 45, 70, 45, 50, 71, GrowthRate.MEDIUM_FAST, 87.5, false),
        new PokemonSpecies(Species.ARCHEOPS, 5, false, false, false, "First Bird Pokémon", Type.ROCK, Type.FLYING, 1.4, 32, Abilities.DEFEATIST, Abilities.NONE, Abilities.EMERGENCY_EXIT, 567, 75, 140, 65, 112, 65, 110, 45, 50, 177, GrowthRate.MEDIUM_FAST, 87.5, false),
        ...
        new PokemonSpecies(Species.EELEKTROSS, 5, false, false, false, "EleFish Pokémon", Type.ELECTRIC, null, 2.1, 80.5, Abilities.LEVITATE, Abilities.NONE, Abilities.NONE, 515, 85, 115, 80, 105, 80, 50, 30, 70, 232, GrowthRate.SLOW, 50, false, true,
            new PokemonForm("Normal", "", Type.ELECTRIC, null, 2.1, 80.5, Abilities.LEVITATE, Abilities.NONE, Abilities.NONE, 515, 85, 115, 80, 105, 80, 50, 30, 70, 232, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.ELECTRIC, null, 2.5, 100, Abilities.SHEER_FORCE, Abilities.SHEER_FORCE, Abilities.LEVITATE, 615, 85, 145, 80, 135, 90, 80, 30, 70, 232, false),
        ),
        ...
        new PokemonSpecies(Species.CHANDELURE, 5, false, false, false, "Luring Pokémon", Type.GHOST, Type.FIRE, 1, 34.3, Abilities.FLASH_FIRE, Abilities.FLAME_BODY, Abilities.INFILTRATOR, 520, 60, 55, 90, 145, 90, 80, 45, 50, 260, GrowthRate.MEDIUM_SLOW, 50, false, true,
            new PokemonForm("Normal", "", Type.GHOST, Type.FIRE, 1, 34.3, Abilities.FLASH_FIRE, Abilities.FLAME_BODY, Abilities.INFILTRATOR, 520, 60, 55, 90, 145, 90, 80, 45, 50, 260, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.GHOST, Type.FIRE, 1.3, 45, Abilities.INFILTRATOR, Abilities.INFILTRATOR, Abilities.FLASH_FIRE, 620, 60, 75, 110, 175, 110, 90, 45, 50, 260, false),
        ),
        ...
        new PokemonSpecies(Species.GOLURK, 5, false, false, false, "Automaton Pokémon", Type.GROUND, Type.GHOST, 2.8, 330, Abilities.IRON_FIST, Abilities.KLUTZ, Abilities.NO_GUARD, 483, 89, 124, 80, 55, 80, 55, 90, 50, 169, GrowthRate.MEDIUM_FAST, null, false, true,
            new PokemonForm("Normal", "", Type.GROUND, Type.GHOST, 2.8, 330, Abilities.IRON_FIST, Abilities.KLUTZ, Abilities.NO_GUARD, 483, 89, 124, 80, 55, 80, 55, 90, 50, 169, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.GROUND, Type.GHOST, 2.8, 330, Abilities.UNSEEN_FIST, Abilities.UNSEEN_FIST, Abilities.NO_GUARD, 583, 89, 159, 105, 70, 105, 55, 90, 50, 169, false),
        ),
        ...
        new PokemonSpecies(Species.CHESNAUGHT, 6, false, false, false, "Spiny Armor Pokémon", Type.GRASS, Type.FIGHTING, 1.6, 90, Abilities.OVERGROW, Abilities.NONE, Abilities.BULLETPROOF, 530, 88, 107, 122, 74, 75, 64, 45, 70, 239, GrowthRate.MEDIUM_SLOW, 87.5, false, true,
            new PokemonForm("Normal", "", Type.GRASS, Type.FIGHTING, 1.6, 90, Abilities.OVERGROW, Abilities.NONE, Abilities.BULLETPROOF, 530, 88, 107, 122, 74, 75, 64, 45, 70, 239, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.GRASS, Type.FIGHTING, 1.9, 110, Abilities.BULLETPROOF, Abilities.BULLETPROOF, Abilities.BULLETPROOF, 630, 88, 137, 172, 74, 115, 44, 45, 70, 239, false),
        ),
        ...
        new PokemonSpecies(Species.DELPHOX, 6, false, false, false, "Fox Pokémon", Type.FIRE, Type.PSYCHIC, 1.5, 39, Abilities.BLAZE, Abilities.NONE, Abilities.MAGICIAN, 534, 75, 69, 72, 114, 100, 104, 45, 70, 240, GrowthRate.MEDIUM_SLOW, 87.5, false, true,
            new PokemonForm("Normal", "", Type.FIRE, Type.PSYCHIC, 1.5, 39, Abilities.BLAZE, Abilities.NONE, Abilities.MAGICIAN, 534, 75, 69, 72, 114, 100, 104, 45, 70, 240, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.FIRE, Type.PSYCHIC, 1.8, 50, Abilities.LEVITATE, Abilities.LEVITATE, Abilities.MAGIC_GUARD, 634, 75, 69, 72, 159, 125, 134, 45, 70, 240, false),
        ),
        ...
        new PokemonSpecies(Species.GRENINJA, 6, false, false, false, "Ninja Pokémon", Type.WATER, Type.DARK, 1.5, 40, Abilities.TORRENT, Abilities.NONE, Abilities.PROTEAN, 530, 72, 95, 67, 103, 71, 122, 45, 70, 239, GrowthRate.MEDIUM_SLOW, 87.5, false, true,
            ...
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.WATER, Type.DARK, 1.8, 50, Abilities.PROTEAN, Abilities.PROTEAN, Abilities.SKILL_LINK, 630, 72, 125, 77, 133, 81, 142, 45, 70, 239, false),
        ),
        ...
        new PokemonSpecies(Species.PYROAR, 6, false, false, false, "Royal Pokémon", Type.FIRE, Type.NORMAL, 1.5, 81.5, Abilities.RIVALRY, Abilities.UNNERVE, Abilities.MOXIE, 507, 86, 68, 72, 109, 66, 106, 65, 70, 177, GrowthRate.MEDIUM_SLOW, 12.5, true, true,
            new PokemonForm("Normal", "", Type.FIRE, Type.NORMAL, 1.5, 81.5, Abilities.RIVALRY, Abilities.UNNERVE, Abilities.MOXIE, 507, 86, 68, 72, 109, 66, 106, 65, 70, 177, true, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.FIRE, Type.NORMAL, 1.8, 100, Abilities.SPEED_BOOST, Abilities.SPEED_BOOST, Abilities.MOXIE, 607, 86, 88, 92, 129, 86, 126, 65, 70, 177, true),
        ),
        ...
        new PokemonSpecies(Species.FLOETTE, 6, false, false, false, "Single Bloom Pokémon", Type.FAIRY, null, 0.2, 0.9, Abilities.FLOWER_VEIL, Abilities.NONE, Abilities.SYMBIOSIS, 371, 54, 45, 47, 75, 98, 52, 120, 70, 130, GrowthRate.MEDIUM_FAST, 0, false, true,
            ...
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.FAIRY, null, 0.4, 2, Abilities.FAIRY_AURA, Abilities.FAIRY_AURA, Abilities.MISTY_SURGE, 651, 74, 85, 87, 155, 148, 102, 120, 70, 130, false),
        ),
        ...
        new PokemonSpecies(Species.MEOWSTIC, 6, false, false, false, "Constraint Pokémon", Type.PSYCHIC, null, 0.6, 8.5, Abilities.KEEN_EYE, Abilities.INFILTRATOR, Abilities.PRANKSTER, 466, 74, 48, 76, 83, 81, 104, 75, 50, 163, GrowthRate.MEDIUM_FAST, 50, false, false,
            ...
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.PSYCHIC, null, 0.6, 8.5, Abilities.TRACE, Abilities.TRACE, Abilities.PRANKSTER, 566, 74, 48, 76, 143, 101, 124, 75, 50, 163, false),
        ),
        ...
        new PokemonSpecies(Species.MALAMAR, 6, false, false, false, "Overturning Pokémon", Type.DARK, Type.PSYCHIC, 1.5, 47, Abilities.CONTRARY, Abilities.SUCTION_CUPS, Abilities.INFILTRATOR, 482, 86, 92, 88, 68, 75, 73, 80, 50, 169, GrowthRate.MEDIUM_FAST, 50, false, true,
            new PokemonForm("Normal", "", Type.DARK, Type.PSYCHIC, 1.5, 47, Abilities.CONTRARY, Abilities.SUCTION_CUPS, Abilities.INFILTRATOR, 482, 86, 92, 88, 68, 75, 73, 80, 50, 169, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.DARK, Type.PSYCHIC, 1.8, 60, Abilities.CONTRARY, Abilities.CONTRARY, Abilities.INFILTRATOR, 582, 86, 102, 88, 98, 120, 88, 80, 50, 169, false),
        ),
        ...
        new PokemonSpecies(Species.BARBARACLE, 6, false, false, false, "Collective Pokémon", Type.ROCK, Type.WATER, 1.3, 96, Abilities.TOUGH_CLAWS, Abilities.SNIPER, Abilities.PICKPOCKET, 500, 72, 105, 115, 54, 86, 68, 45, 50, 175, GrowthRate.MEDIUM_FAST, 50, false, true,
            new PokemonForm("Normal", "", Type.ROCK, Type.WATER, 1.3, 96, Abilities.TOUGH_CLAWS, Abilities.SNIPER, Abilities.PICKPOCKET, 500, 72, 105, 115, 54, 86, 68, 45, 50, 175, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.ROCK, Type.FIGHTING, 1.6, 120, Abilities.SAND_RUSH, Abilities.SAND_RUSH, Abilities.PICKPOCKET, 600, 72, 140, 130, 64, 106, 88, 45, 50, 175, false),
        ),
        ...
        new PokemonSpecies(Species.DRAGALGE, 6, false, false, false, "Mock Kelp Pokémon", Type.POISON, Type.DRAGON, 1.8, 81.5, Abilities.POISON_POINT, Abilities.POISON_TOUCH, Abilities.ADAPTABILITY, 494, 65, 75, 90, 97, 123, 44, 55, 50, 173, GrowthRate.MEDIUM_FAST, 50, false, true,
            new PokemonForm("Normal", "", Type.POISON, Type.DRAGON, 1.8, 81.5, Abilities.POISON_POINT, Abilities.POISON_TOUCH, Abilities.ADAPTABILITY, 494, 65, 75, 90, 97, 123, 44, 55, 50, 173, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.POISON, Type.DRAGON, 2.2, 100, Abilities.PROTEAN, Abilities.PROTEAN, Abilities.ADAPTABILITY, 594, 65, 85, 105, 132, 163, 44, 55, 50, 173, false),
        ),
        ...
        new PokemonSpecies(Species.HAWLUCHA, 6, false, false, false, "Wrestling Pokémon", Type.FIGHTING, Type.FLYING, 0.8, 21.5, Abilities.LIMBER, Abilities.UNBURDEN, Abilities.MOLD_BREAKER, 500, 78, 92, 75, 74, 63, 118, 100, 50, 175, GrowthRate.MEDIUM_FAST, 50, false, true,
            new PokemonForm("Normal", "", Type.FIGHTING, Type.FLYING, 0.8, 21.5, Abilities.LIMBER, Abilities.UNBURDEN, Abilities.MOLD_BREAKER, 500, 78, 92, 75, 74, 63, 118, 100, 50, 175, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.FIGHTING, Type.FLYING, 1.0, 30, Abilities.NO_GUARD, Abilities.NO_GUARD, Abilities.AERILATE, 600, 78, 137, 100, 74, 93, 118, 100, 50, 175, false),
        ),
        ...
        new PokemonSpecies(Species.ZYGARDE, 6, false, true, false, "Order Pokémon", Type.DRAGON, Type.GROUND, 5, 305, Abilities.AURA_BREAK, Abilities.NONE, Abilities.NONE, 600, 108, 100, 121, 81, 95, 95, 3, 0, 300, GrowthRate.SLOW, null, false, true,
            ...
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.DRAGON, Type.GROUND, 6, 400, Abilities.MULTISCALE, Abilities.MULTISCALE, Abilities.AURA_BREAK, 778, 216, 70, 91, 216, 85, 100, 3, 0, 300, false),
        ),
        ...
        new PokemonSpecies(Species.CRABOMINABLE, 7, false, false, false, "Woolly Crab Pokémon", Type.FIGHTING, Type.ICE, 1.7, 180, Abilities.HYPER_CUTTER, Abilities.IRON_FIST, Abilities.ANGER_POINT, 478, 97, 132, 77, 62, 67, 43, 60, 70, 167, GrowthRate.MEDIUM_FAST, 50, false, true,
            new PokemonForm("Normal", "", Type.FIGHTING, Type.ICE, 1.7, 180, Abilities.HYPER_CUTTER, Abilities.IRON_FIST, Abilities.ANGER_POINT, 478, 97, 132, 77, 62, 67, 43, 60, 70, 167, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.FIGHTING, Type.ICE, 1.7, 180, Abilities.IRON_FIST, Abilities.IRON_FIST, Abilities.ANGER_POINT, 578, 97, 157, 122, 62, 107, 33, 60, 70, 167, false),
        ),
        ...
        new PokemonSpecies(Species.WIMPOD, 7, false, false, false, "Turn Tail Pokémon", Type.BUG, Type.WATER, 0.5, 12, Abilities.WIMP_OUT, Abilities.NONE, Abilities.RUN_AWAY, 230, 25, 35, 40, 20, 30, 80, 90, 50, 46, GrowthRate.MEDIUM_FAST, 50, false),
        new PokemonSpecies(Species.GOLISOPOD, 7, false, false, false, "Hard Scale Pokémon", Type.BUG, Type.WATER, 2, 108, Abilities.EMERGENCY_EXIT, Abilities.NONE, Abilities.ANTICIPATION, 530, 75, 125, 140, 60, 90, 40, 45, 50, 186, GrowthRate.MEDIUM_FAST, 50, false, true,
            new PokemonForm("Normal", "", Type.BUG, Type.WATER, 2, 108, Abilities.EMERGENCY_EXIT, Abilities.NONE, Abilities.ANTICIPATION, 530, 75, 125, 140, 60, 90, 40, 45, 50, 186, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.BUG, Type.STEEL, 2, 108, Abilities.TOUGH_CLAWS, Abilities.TOUGH_CLAWS, Abilities.EMERGENCY_EXIT, 630, 75, 150, 175, 70, 120, 40, 45, 50, 186, false),
        ),
        ...
        new PokemonSpecies(Species.DRAMPA, 7, false, false, false, "Placid Pokémon", Type.NORMAL, Type.DRAGON, 3, 185, Abilities.BERSERK, Abilities.SAP_SIPPER, Abilities.CLOUD_NINE, 485, 78, 60, 85, 135, 91, 36, 70, 50, 170, GrowthRate.MEDIUM_FAST, 50, false, true,
            new PokemonForm("Normal", "", Type.NORMAL, Type.DRAGON, 3, 185, Abilities.BERSERK, Abilities.SAP_SIPPER, Abilities.CLOUD_NINE, 485, 78, 60, 85, 135, 91, 36, 70, 50, 170, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.NORMAL, Type.DRAGON, 3.5, 220, Abilities.BERSERK, Abilities.BERSERK, Abilities.GALVANIZE, 585, 78, 85, 110, 160, 116, 36, 70, 50, 170, false),
        ),
        ...
        new PokemonSpecies(Species.MAGEARNA, 7, false, false, true, "Artificial Pokémon", Type.STEEL, Type.FAIRY, 1, 80.5, Abilities.SOUL_HEART, Abilities.NONE, Abilities.NONE, 600, 80, 95, 115, 130, 115, 65, 3, 0, 300, GrowthRate.SLOW, null, false, true,
            ...
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.STEEL, Type.FAIRY, 1, 80.5, Abilities.SOUL_HEART, Abilities.SOUL_HEART, Abilities.NONE, 700, 80, 125, 115, 170, 115, 95, 3, 0, 300, false),
        ),
        ...
        new PokemonSpecies(Species.ZERAORA, 7, false, false, true, "Thunderclap Pokémon", Type.ELECTRIC, null, 1.5, 44.5, Abilities.VOLT_ABSORB, Abilities.NONE, Abilities.NONE, 600, 88, 112, 75, 102, 80, 143, 3, 0, 300, GrowthRate.SLOW, null, false, true,
            new PokemonForm("Normal", "", Type.ELECTRIC, null, 1.5, 44.5, Abilities.VOLT_ABSORB, Abilities.NONE, Abilities.NONE, 600, 88, 112, 75, 102, 80, 143, 3, 0, 300, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.ELECTRIC, null, 1.5, 44.5, Abilities.SPEED_BOOST, Abilities.SPEED_BOOST, Abilities.VOLT_ABSORB, 700, 88, 157, 75, 147, 80, 153, 3, 0, 300, false),
        ),
        ...
        new PokemonSpecies(Species.FALINKS, 8, false, false, false, "Formation Pokémon", Type.FIGHTING, null, 3, 62, Abilities.BATTLE_ARMOR, Abilities.NONE, Abilities.DEFIANT, 470, 65, 100, 100, 70, 60, 75, 45, 50, 165, GrowthRate.MEDIUM_FAST, null, false, true,
            new PokemonForm("Normal", "", Type.FIGHTING, null, 3, 62, Abilities.BATTLE_ARMOR, Abilities.NONE, Abilities.DEFIANT, 470, 65, 100, 100, 70, 60, 75, 45, 50, 165, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.FIGHTING, null, 3.5, 80, Abilities.TECHNICIAN, Abilities.TECHNICIAN, Abilities.DEFIANT, 570, 65, 135, 135, 70, 65, 100, 45, 50, 165, false),
        ),
        ...
        new PokemonSpecies(Species.SCOVILLAIN, 9, false, false, false, "Spicy Pepper Pokémon", Type.GRASS, Type.FIRE, 0.9, 15, Abilities.CHLOROPHYLL, Abilities.INSOMNIA, Abilities.MOODY, 486, 65, 108, 65, 108, 65, 75, 75, 50, 170, GrowthRate.MEDIUM_FAST, 50, false, true,
            new PokemonForm("Normal", "", Type.GRASS, Type.FIRE, 0.9, 15, Abilities.CHLOROPHYLL, Abilities.INSOMNIA, Abilities.MOODY, 486, 65, 108, 65, 108, 65, 75, 75, 50, 170, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.GRASS, Type.FIRE, 0.9, 15, Abilities.SPICY_SPRAY, Abilities.SPICY_SPRAY, Abilities.MOODY, 586, 65, 138, 85, 138, 85, 75, 75, 50, 170, false),
        ),
        ...
        new PokemonSpecies(Species.GLIMMORA, 9, false, false, false, "Ore Pokémon", Type.ROCK, Type.POISON, 1.5, 45, Abilities.TOXIC_DEBRIS, Abilities.NONE, Abilities.CORROSION, 525, 83, 55, 90, 130, 81, 86, 25, 50, 184, GrowthRate.MEDIUM_SLOW, 50, false, true,
            new PokemonForm("Normal", "", Type.ROCK, Type.POISON, 1.5, 45, Abilities.TOXIC_DEBRIS, Abilities.NONE, Abilities.CORROSION, 525, 83, 55, 90, 130, 81, 86, 25, 50, 184, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.ROCK, Type.POISON, 1.5, 45, Abilities.ADAPTABILITY, Abilities.ADAPTABILITY, Abilities.CORROSION, 625, 83, 90, 105, 150, 96, 101, 25, 50, 184, false),
        ),
        ...
        new PokemonSpecies(Species.TATSUGIRI, 9, false, false, false, "Mimicry Pokémon", Type.DRAGON, Type.WATER, 0.3, 8, Abilities.COMMANDER, Abilities.NONE, Abilities.STORM_DRAIN, 475, 68, 50, 60, 120, 95, 82, 100, 50, 166, GrowthRate.MEDIUM_SLOW, 50, false, true,
            ...
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.DRAGON, Type.WATER, 0.3, 8, Abilities.DRAGONS_MAW, Abilities.DRAGONS_MAW, Abilities.STORM_DRAIN, 575, 68, 65, 90, 135, 125, 92, 100, 50, 166, false),
        ),
        ...
        new PokemonSpecies(Species.BAXCALIBUR, 9, false, false, false, "Ice Dragon Pokémon", Type.DRAGON, Type.ICE, 2.1, 210, Abilities.THERMAL_EXCHANGE, Abilities.NONE, Abilities.ICE_BODY, 600, 115, 145, 92, 75, 86, 87, 10, 50, 300, GrowthRate.SLOW, 50, false, true,
            new PokemonForm("Normal", "", Type.DRAGON, Type.ICE, 2.1, 210, Abilities.THERMAL_EXCHANGE, Abilities.NONE, Abilities.ICE_BODY, 600, 115, 145, 92, 75, 86, 87, 10, 50, 300, false, null, true),
            new PokemonForm("Mega", SpeciesFormKey.MEGA, Type.DRAGON, Type.ICE, 2.1, 210, Abilities.THERMAL_EXCHANGE, Abilities.THERMAL_EXCHANGE, Abilities.ICE_BODY, 677, 115, 170, 105, 80, 105, 102, 10, 50, 300, false),
        ),
        ...
        new PokemonSpecies(Species.ALIEN_MOTHER, 20, false, false, true, "Duel Monster", Type.PSYCHIC, Type.STEEL, 1.0, 50.0, Abilities.A_PARASITIC_OFFSPRING, Abilities.NONE, Abilities.NONE, 580, 80, 120, 80, 100, 100, 100, 15, 50, 290, GrowthRate.SLOW, null, false),
        new PokemonSpecies(Species.ALLIGATORS_SWORD_DRAGON, 20, false, false, false, "Duel Monster", Type.DRAGON, Type.FLYING, 1.0, 50.0, Abilities.ELEMENTAL_BYPASS, Abilities.NONE, Abilities.NONE, 530, 75, 120, 75, 70, 70, 120, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.ANCIENT_GEAR_BOX, 20, false, false, false, "Duel Monster", Type.STEEL, Type.GROUND, 1.0, 50.0, Abilities.ANCIENT_SUPPLIES, Abilities.NONE, Abilities.NONE, 530, 105, 95, 125, 60, 90, 55, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.ANCIENT_TREE_OF_ENLIGHTENMENT, 20, false, false, false, "Duel Monster", Type.GRASS, Type.FAIRY, 1.0, 50.0, Abilities.DEEP_ROOTS, Abilities.NONE, Abilities.NONE, 540, 120, 45, 110, 100, 130, 35, 30, 50, 270, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.ARCANA_FORCE_I_THE_MAGICIAN, 20, false, false, false, "Duel Monster", Type.PSYCHIC, Type.FAIRY, 1.0, 50.0, Abilities.MAGICIANS_COIN, Abilities.NONE, Abilities.NONE, 530, 85, 60, 80, 125, 95, 85, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.ALPHA_THE_MAGNET_WARRIOR, 20, false, false, false, "Duel Monster", Type.ELECTRIC, Type.ROCK, 1.0, 50.0, Abilities.POLARIZE_ALPHA, Abilities.NONE, Abilities.NONE, 540, 75, 105, 95, 90, 85, 90, 30, 50, 270, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.ANCIENT_GEAR, 20, false, false, false, "Duel Monster", Type.STEEL, Type.NORMAL, 1.0, 50.0, Abilities.ANCIENT_SUMMON, Abilities.NONE, Abilities.NONE, 500, 85, 95, 85, 50, 85, 100, 45, 50, 250, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.ANCIENT_GEAR_ENGINEER, 20, false, false, false, "Duel Monster", Type.STEEL, Type.ELECTRIC, 1.0, 50.0, Abilities.ANCIENT_DRILL, Abilities.NONE, Abilities.NONE, 530, 110, 120, 85, 40, 65, 110, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.ANCIENT_GEAR_GOLEM, 20, true, false, false, "Duel Monster", Type.STEEL, Type.GROUND, 1.0, 50.0, Abilities.ANCIENT_BEHEMOTH, Abilities.NONE, Abilities.NONE, 570, 105, 140, 120, 55, 100, 50, 15, 50, 285, GrowthRate.MEDIUM_SLOW, null, false),
        new PokemonSpecies(Species.ANCIENT_GEAR_KNIGHT, 20, false, false, false, "Duel Monster", Type.NORMAL, null, 1.0, 50.0, Abilities.ANCIENT_DUAL_CORE, Abilities.NONE, Abilities.NONE, 500, 75, 115, 95, 50, 70, 95, 45, 50, 250, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.ARCANA_FORCE_IV_THE_EMPEROR, 20, true, false, false, "Duel Monster", Type.ELECTRIC, Type.FAIRY, 1.0, 50.0, Abilities.EMPERORS_COIN, Abilities.NONE, Abilities.NONE, 570, 95, 105, 100, 100, 100, 70, 15, 50, 285, GrowthRate.MEDIUM_SLOW, null, false),
        new PokemonSpecies(Species.ARCANA_FORCE_XVIII_THE_MOON, 20, false, true, false, "Duel Monster", Type.DARK, Type.FAIRY, 1.0, 50.0, Abilities.MOONS_COIN, Abilities.NONE, Abilities.NONE, 600, 115, 85, 95, 120, 110, 75, 15, 50, 300, GrowthRate.FLUCTUATING, null, false),
        new PokemonSpecies(Species.ARCANA_FORCE_VI_THE_LOVERS, 20, false, false, false, "Duel Monster", Type.FIRE, Type.FAIRY, 1.0, 50.0, Abilities.LOVERS_COIN, Abilities.NONE, Abilities.NONE, 530, 80, 60, 75, 125, 95, 95, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.ARCANA_FORCE_EX_THE_DARK_RULER, 20, false, true, false, "Duel Monster", Type.DARK, Type.FAIRY, 1.0, 50.0, Abilities.TYRANTS_COIN, Abilities.NONE, Abilities.NONE, 600, 100, 120, 85, 125, 85, 85, 15, 50, 300, GrowthRate.FLUCTUATING, null, false),
        new PokemonSpecies(Species.ARCANA_FORCE_0_THE_FOOL, 20, false, false, false, "Duel Monster", Type.NORMAL, Type.FAIRY, 1.0, 50.0, Abilities.FOOLS_COIN, Abilities.NONE, Abilities.NONE, 510, 80, 55, 75, 100, 90, 110, 30, 50, 255, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.ARCHFIEND_ZOMBIE, 20, false, false, false, "Duel Monster", Type.GHOST, Type.ELECTRIC, 1.0, 50.0, Abilities.UNDEAD_ARCHFIEND, Abilities.NONE, Abilities.NONE, 550, 70, 110, 70, 130, 70, 100, 30, 50, 275, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.ARMED_DRAGON_LV3, 20, false, false, false, "Duel Monster", Type.DRAGON, Type.FLYING, 1.0, 50.0, Abilities.EXPERIENCE_BOOST, Abilities.NONE, Abilities.NONE, 500, 90, 110, 70, 55, 70, 105, 45, 50, 250, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.ARMED_DRAGON_LV5, 20, false, false, false, "Duel Monster", Type.DRAGON, Type.FIGHTING, 1.0, 50.0, Abilities.WINDBOLT_DISCARD, Abilities.NONE, Abilities.NONE, 530, 80, 120, 95, 55, 80, 100, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.ARMED_DRAGON_LV7, 20, true, false, false, "Duel Monster", Type.DRAGON, Type.STEEL, 1.0, 50.0, Abilities.WINDSTORM_DISCARD, Abilities.NONE, Abilities.NONE, 570, 100, 125, 70, 95, 75, 105, 15, 50, 285, GrowthRate.MEDIUM_SLOW, null, false),
        new PokemonSpecies(Species.AVATAR_OF_THE_POT, 20, false, false, false, "Duel Monster", Type.ROCK, Type.FAIRY, 1.0, 50.0, Abilities.DRAW_THREE, Abilities.NONE, Abilities.NONE, 500, 90, 55, 95, 100, 95, 65, 45, 50, 250, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.AXE_RAIDER, 20, false, false, false, "Duel Monster", Type.NORMAL, Type.FIGHTING, 1.0, 50.0, Abilities.RAGING_AXE, Abilities.NONE, Abilities.NONE, 530, 100, 155, 75, 35, 50, 115, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.BABY_DRAGON, 20, false, false, false, "Duel Monster", Type.DRAGON, Type.FLYING, 1.0, 50.0, Abilities.TIME_WIZARDS_BLESSING, Abilities.NONE, Abilities.NONE, 500, 80, 70, 70, 110, 70, 100, 45, 50, 250, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.BEAN_SOLDIER, 20, false, false, false, "Duel Monster", Type.GRASS, Type.FIGHTING, 1.0, 50.0, Abilities.QUICK_HARVEST, Abilities.NONE, Abilities.NONE, 500, 100, 110, 65, 50, 60, 115, 45, 50, 250, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.BEAVER_WARRIOR, 20, false, false, false, "Duel Monster", Type.WATER, Type.FIGHTING, 1.0, 50.0, Abilities.DAM_BUILDER, Abilities.NONE, Abilities.NONE, 500, 105, 105, 100, 40, 80, 70, 45, 50, 250, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.BEHEMOTH_THE_KING_OF_ALL_ANIMALS, 20, false, false, false, "Duel Monster", Type.GROUND, Type.GRASS, 1.0, 50.0, Abilities.KINGS_ROAR, Abilities.NONE, Abilities.NONE, 560, 120, 145, 110, 50, 85, 50, 30, 50, 280, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.BEIIGE_VANGUARD_OF_DARK_WORLD, 20, false, false, false, "Duel Monster", Type.DARK, Type.FIGHTING, 1.0, 50.0, Abilities.DARKWORLD_TACTICS, Abilities.NONE, Abilities.NONE, 520, 120, 105, 85, 55, 70, 85, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.ABAKI, 20, false, false, false, "Duel Monster", Type.FIRE, Type.DARK, 1.0, 50.0, Abilities.CURSED_FLAMES_YU, Abilities.NONE, Abilities.NONE, 530, 75, 130, 70, 85, 65, 105, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.ABARE_USHIONI, 20, false, false, false, "Duel Monster", Type.FIGHTING, Type.GROUND, 1.0, 50.0, Abilities.BULL_RUSH, Abilities.NONE, Abilities.NONE, 520, 80, 155, 70, 45, 65, 105, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.AGIDO, 20, false, false, false, "Duel Monster", Type.FAIRY, Type.GROUND, 1.0, 50.0, Abilities.FATED_REVIVAL, Abilities.NONE, Abilities.NONE, 530, 70, 100, 70, 105, 85, 100, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.AITSU, 20, false, false, false, "Duel Monster", Type.FLYING, Type.FIRE, 1.0, 50.0, Abilities.TRAVEL_BUDDIES_RED, Abilities.NONE, Abilities.NONE, 500, 80, 90, 70, 90, 70, 100, 45, 50, 250, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.ALIEN_GREY, 20, false, false, false, "Duel Monster", Type.PSYCHIC, Type.POISON, 1.0, 50.0, Abilities.A_COUNTER_INFECTOR, Abilities.NONE, Abilities.NONE, 500, 85, 80, 60, 95, 75, 105, 45, 50, 250, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.ALIEN_MARS, 20, false, false, false, "Duel Monster", Type.PSYCHIC, Type.ROCK, 1.0, 50.0, Abilities.A_SUPPRESSION, Abilities.NONE, Abilities.NONE, 530, 85, 90, 85, 100, 90, 80, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.BETA_THE_MAGNET_WARRIOR, 20, false, false, false, "Duel Monster", Type.STEEL, Type.ELECTRIC, 1.0, 50.0, Abilities.MAGNETIZE_BETA, Abilities.NONE, Abilities.NONE, 510, 90, 85, 115, 70, 100, 50, 30, 50, 255, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.BICKURIBOX, 20, false, false, false, "Duel Monster", Type.DARK, Type.FAIRY, 1.0, 50.0, Abilities.CREEPY_SURPRISE, Abilities.NONE, Abilities.NONE, 540, 70, 120, 70, 100, 70, 110, 30, 50, 270, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.BIG_JAWS, 20, false, false, false, "Duel Monster", Type.WATER, Type.STEEL, 1.0, 50.0, Abilities.IRON_JAWS, Abilities.NONE, Abilities.NONE, 500, 80, 120, 80, 45, 70, 105, 45, 50, 250, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.BIO_PLANT, 20, false, false, false, "Duel Monster", Type.GRASS, Type.POISON, 1.0, 50.0, Abilities.CARNIVOROUS_VINES, Abilities.NONE, Abilities.NONE, 530, 105, 90, 75, 100, 80, 80, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.BLACK_DRAGONS_CHICK, 20, false, false, false, "Duel Monster", Type.FIRE, Type.DRAGON, 1.0, 50.0, Abilities.BLACK_FLAME_SPARK, Abilities.NONE, Abilities.NONE, 500, 80, 90, 75, 90, 75, 90, 45, 50, 250, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.BLACK_LUSTER_SOLDIER, 20, false, false, true, "Duel Monster", Type.DARK, Type.FAIRY, 1.0, 50.0, Abilities.CHAOS_WARRIOR, Abilities.NONE, Abilities.NONE, 590, 90, 130, 95, 90, 85, 100, 15, 50, 295, GrowthRate.SLOW, null, false),
        new PokemonSpecies(Species.BLACK_LUSTER_SOLDIER_ENVOY_OF_THE_BEGINNING, 20, false, true, false, "Duel Monster", Type.FAIRY, Type.DARK, 1.0, 50.0, Abilities.LUSTER_GENESIS, Abilities.NONE, Abilities.NONE, 650, 115, 145, 115, 70, 105, 100, 5, 50, 325, GrowthRate.FLUCTUATING, null, false),
        new PokemonSpecies(Species.BLACK_MAGICIAN_OF_CHAOS, 20, false, false, true, "Duel Monster", Type.PSYCHIC, Type.DARK, 1.0, 50.0, Abilities.CHAOS_SORCERER, Abilities.NONE, Abilities.NONE, 590, 75, 70, 70, 155, 90, 130, 15, 50, 295, GrowthRate.SLOW, null, false),
        new PokemonSpecies(Species.BLACK_TYRANNO, 20, false, false, false, "Duel Monster", Type.DARK, Type.ROCK, 1.0, 50.0, Abilities.CRITICAL_PREDATOR, Abilities.NONE, Abilities.NONE, 530, 90, 145, 90, 50, 65, 90, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.BLADE_KNIGHT, 20, false, false, false, "Duel Monster", Type.FIGHTING, Type.STEEL, 1.0, 50.0, Abilities.FINAL_BLADE, Abilities.NONE, Abilities.NONE, 530, 100, 120, 80, 45, 60, 125, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.BLAZING_INPACHI, 20, false, false, false, "Duel Monster", Type.FIRE, Type.GRASS, 1.0, 50.0, Abilities.BLAZING_TIMBER, Abilities.NONE, Abilities.NONE, 530, 80, 125, 100, 75, 70, 80, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.BLIZZARD_DRAGON, 20, false, false, false, "Duel Monster", Type.ICE, Type.DRAGON, 1.0, 50.0, Abilities.ABSOLUTE_ZERO, Abilities.NONE, Abilities.NONE, 520, 70, 85, 70, 110, 75, 110, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.BLOWBACK_DRAGON, 20, false, false, false, "Duel Monster", Type.DRAGON, Type.DARK, 1.0, 50.0, Abilities.BLOWBACK_ROULETTE, Abilities.NONE, Abilities.NONE, 560, 80, 110, 85, 110, 75, 100, 30, 50, 280, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.BLUE_EYES_ALTERNATIVE_WHITE_DRAGON, 20, false, true, false, "Duel Monster", Type.DRAGON, Type.ELECTRIC, 1.0, 50.0, Abilities.ALTERNATIVE_BURST, Abilities.NONE, Abilities.NONE, 610, 95, 105, 95, 140, 95, 80, 15, 50, 305, GrowthRate.FLUCTUATING, null, false),
        new PokemonSpecies(Species.BLUE_EYES_CHAOS_MAX_DRAGON, 20, false, true, false, "Duel Monster", Type.DRAGON, Type.DARK, 1.0, 50.0, Abilities.MAX_DESTRUCTION, Abilities.NONE, Abilities.NONE, 700, 100, 135, 105, 160, 100, 100, 5, 50, 350, GrowthRate.FLUCTUATING, null, false),
        new PokemonSpecies(Species.BLUE_EYES_TOON_DRAGON_RENDER, 20, false, false, true, "Duel Monster", Type.DRAGON, Type.FAIRY, 1.0, 50.0, Abilities.LOONEY_DRAGON, Abilities.NONE, Abilities.NONE, 590, 85, 85, 75, 130, 85, 130, 15, 50, 295, GrowthRate.SLOW, null, false),
        new PokemonSpecies(Species.BLUE_EYES_ULTIMATE_DRAGON, 20, false, true, false, "Duel Monster", Type.DRAGON, Type.FLYING, 1.0, 50.0, Abilities.TRIPLE_BURST, Abilities.NONE, Abilities.NONE, 700, 95, 145, 105, 155, 95, 105, 5, 50, 350, GrowthRate.FLUCTUATING, null, false),
        new PokemonSpecies(Species.BLUE_EYES_WHITE_DRAGON, 20, false, true, false, "Duel Monster", Type.DRAGON, Type.ELECTRIC, 1.0, 50.0, Abilities.WHITE_LIGHTNING, Abilities.NONE, Abilities.NONE, 600, 85, 105, 85, 150, 95, 80, 15, 50, 300, GrowthRate.FLUCTUATING, null, false),
        new PokemonSpecies(Species.BOO_KOO, 20, false, false, false, "Duel Monster", Type.FAIRY, Type.PSYCHIC, 1.0, 50.0, Abilities.ANCIENT_KNOWLEDGE, Abilities.NONE, Abilities.NONE, 500, 70, 50, 75, 105, 75, 125, 45, 50, 250, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.BREAKER_THE_MAGICAL_WARRIOR, 20, false, false, false, "Duel Monster", Type.STEEL, Type.PSYCHIC, 1.0, 50.0, Abilities.SPELLBREAKER_BLADE, Abilities.NONE, Abilities.NONE, 530, 80, 120, 80, 85, 80, 85, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.BUSTER_BLADER_DESTRUCTION_SWORDMASTER, 20, false, false, false, "Duel Monster", Type.FIGHTING, Type.STEEL, 1.0, 50.0, Abilities.DRAGONBANE_SWORD, Abilities.NONE, Abilities.NONE, 560, 95, 125, 100, 60, 85, 95, 30, 50, 280, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.CAIUS_THE_SHADOW_MONARCH, 20, true, false, false, "Duel Monster", Type.DARK, Type.GHOST, 1.0, 50.0, Abilities.VOID_BANISHMENT, Abilities.NONE, Abilities.NONE, 570, 90, 95, 100, 115, 95, 75, 15, 50, 285, GrowthRate.MEDIUM_SLOW, null, false),
        new PokemonSpecies(Species.CARD_TROOPER, 20, false, false, false, "Duel Monster", Type.ELECTRIC, Type.STEEL, 1.0, 50.0, Abilities.MILL_ENGINE, Abilities.NONE, Abilities.NONE, 520, 90, 85, 90, 80, 70, 105, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.CASTLE_OF_DARK_ILLUSIONS, 20, false, false, false, "Duel Monster", Type.FLYING, Type.GHOST, 1.0, 50.0, Abilities.CRIPPLING_ILLUSIONS, Abilities.NONE, Abilities.NONE, 530, 125, 55, 110, 100, 115, 25, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.CELTIC_GUARDIAN, 20, false, false, false, "Duel Monster", Type.FAIRY, Type.FIGHTING, 1.0, 50.0, Abilities.FOREST_GUARDIAN, Abilities.NONE, Abilities.NONE, 510, 80, 105, 75, 80, 55, 115, 30, 50, 255, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.CHAOS_EMPEROR_DRAGON_ENVOY_OF_THE_END, 20, false, true, false, "Duel Monster", Type.DARK, Type.DRAGON, 1.0, 50.0, Abilities.CHAOS_END, Abilities.NONE, Abilities.NONE, 600, 100, 125, 85, 125, 80, 85, 15, 50, 300, GrowthRate.FLUCTUATING, null, false),
        new PokemonSpecies(Species.CLAW_REACHER, 20, false, false, false, "Duel Monster", Type.POISON, Type.STEEL, 1.0, 50.0, Abilities.SHADOW_REACH, Abilities.NONE, Abilities.NONE, 510, 78, 122, 78, 52, 70, 110, 30, 50, 255, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.CLOUDIAN_ACID_CLOUD, 20, false, false, false, "Duel Monster", Type.FLYING, Type.POISON, 1.0, 50.0, Abilities.ACID_RAIN, Abilities.NONE, Abilities.NONE, 540, 105, 45, 110, 105, 110, 65, 30, 50, 270, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.CLOUDIAN_EYE_OF_THE_TYPHOON, 20, true, false, false, "Duel Monster", Type.FLYING, Type.ELECTRIC, 1.0, 50.0, Abilities.CYCLONIC_SHIFT, Abilities.NONE, Abilities.NONE, 570, 100, 75, 70, 125, 70, 130, 15, 50, 285, GrowthRate.MEDIUM_SLOW, null, false),
        new PokemonSpecies(Species.CLOUDIAN_GHOST_FOG, 20, false, false, false, "Duel Monster", Type.WATER, Type.GHOST, 1.0, 50.0, Abilities.SPECTRAL_MIST, Abilities.NONE, Abilities.NONE, 530, 85, 50, 70, 120, 85, 120, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.CLOUDIAN_NIMBUSMAN, 20, false, false, false, "Duel Monster", Type.FLYING, Type.WATER, 1.0, 50.0, Abilities.FOG_BODY, Abilities.NONE, Abilities.NONE, 530, 105, 95, 100, 80, 95, 55, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.CLOUDIAN_SMOKE_BALL, 20, false, false, false, "Duel Monster", Type.FAIRY, Type.FLYING, 1.0, 50.0, Abilities.SILENT_ASSASSIN, Abilities.NONE, Abilities.NONE, 510, 75, 50, 60, 105, 80, 140, 30, 50, 255, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.CLOUDIAN_STORM_DRAGON, 20, false, false, false, "Duel Monster", Type.ELECTRIC, Type.DRAGON, 1.0, 50.0, Abilities.FOG_BREATH, Abilities.NONE, Abilities.NONE, 550, 80, 85, 75, 125, 80, 105, 30, 50, 275, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.COLOSSAL_FIGHTER, 20, false, false, false, "Duel Monster", Type.FIGHTING, Type.GROUND, 1.0, 50.0, Abilities.UNDYING_SOUL, Abilities.NONE, Abilities.NONE, 550, 100, 140, 110, 55, 80, 65, 30, 50, 275, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.COPYCAT, 20, false, false, false, "Duel Monster", Type.PSYCHIC, Type.FAIRY, 1.0, 50.0, Abilities.MIRROR_KING, Abilities.NONE, Abilities.NONE, 520, 100, 80, 80, 80, 80, 100, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.CRAB_TURTLE, 20, false, false, false, "Duel Monster", Type.WATER, Type.BUG, 1.0, 50.0, Abilities.AQUATIC_RITUAL, Abilities.NONE, Abilities.NONE, 540, 100, 105, 115, 70, 80, 70, 30, 50, 270, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.CRYSTAL_BEAST_AMBER_MAMMOTH, 20, false, false, false, "Duel Monster", Type.ROCK, Type.GROUND, 1.0, 50.0, Abilities.GEMSTONE_TRAMPLE, Abilities.NONE, Abilities.NONE, 530, 100, 130, 100, 45, 75, 80, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.CRYSTAL_BEAST_EMERALD_TORTOISE, 20, false, false, false, "Duel Monster", Type.ROCK, Type.WATER, 1.0, 50.0, Abilities.EMERALD_STANCE, Abilities.NONE, Abilities.NONE, 510, 105, 55, 135, 70, 120, 25, 30, 50, 255, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.CRYSTAL_BEAST_RUBY_CARBUNCLE, 20, false, false, false, "Duel Monster", Type.ROCK, Type.FAIRY, 1.0, 50.0, Abilities.GEM_SIPHON, Abilities.NONE, Abilities.NONE, 510, 80, 55, 65, 105, 80, 125, 30, 50, 255, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.CRYSTAL_BEAST_TOPAZ_TIGER, 20, false, false, false, "Duel Monster", Type.ROCK, Type.ELECTRIC, 1.0, 50.0, Abilities.TOPAZ_LIFEORB, Abilities.NONE, Abilities.NONE, 530, 80, 125, 80, 60, 70, 115, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.CURSE_OF_DRAGON, 20, false, false, false, "Duel Monster", Type.GHOST, Type.DRAGON, 1.0, 50.0, Abilities.CURSED_FLAMES_V2, Abilities.NONE, Abilities.NONE, 530, 75, 90, 70, 110, 65, 120, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.CURSE_OF_DRAGONFIRE, 20, false, false, false, "Duel Monster", Type.FIRE, Type.DRAGON, 1.0, 50.0, Abilities.SCORCHED_EARTH, Abilities.NONE, Abilities.NONE, 560, 75, 100, 75, 130, 75, 105, 30, 50, 280, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.CYBER_DINOSAUR, 20, false, false, false, "Duel Monster", Type.STEEL, Type.DRAGON, 1.0, 50.0, Abilities.CYBERNETIC_PREDATOR, Abilities.NONE, Abilities.NONE, 540, 80, 115, 90, 80, 75, 100, 30, 50, 270, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.CYBER_END_DRAGON, 20, false, true, false, "Duel Monster", Type.DRAGON, Type.STEEL, 1.0, 50.0, Abilities.TRIPLE_CORE_ENGINE, Abilities.NONE, Abilities.NONE, 670, 110, 145, 115, 130, 100, 70, 5, 50, 335, GrowthRate.FLUCTUATING, null, false),
        new PokemonSpecies(Species.CYBER_OGRE, 20, false, false, false, "Duel Monster", Type.STEEL, Type.DARK, 1.0, 50.0, Abilities.CYBERNETIC_DISCARD, Abilities.NONE, Abilities.NONE, 540, 85, 150, 90, 50, 80, 85, 30, 50, 270, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.CYBER_SAURUS, 20, false, false, false, "Duel Monster", Type.STEEL, Type.ROCK, 1.0, 50.0, Abilities.LASER_BUSTER_CANNON, Abilities.NONE, Abilities.NONE, 490, 90, 115, 100, 55, 70, 60, 45, 50, 245, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.CYBER_TECH_ALLIGATOR, 20, false, false, false, "Duel Monster", Type.FLYING, Type.STEEL, 1.0, 50.0, Abilities.ORIGINAL_SKY_KING, Abilities.NONE, Abilities.NONE, 540, 75, 115, 80, 65, 65, 140, 30, 50, 270, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.CYBER_TWIN_DRAGON, 20, false, false, false, "Duel Monster", Type.ELECTRIC, Type.STEEL, 1.0, 50.0, Abilities.TWIN_CORE_BURST, Abilities.NONE, Abilities.NONE, 560, 95, 110, 80, 110, 80, 85, 30, 50, 280, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.D_D_CRAZY_BEAST, 20, false, false, false, "Duel Monster", Type.DARK, Type.PSYCHIC, 1.0, 50.0, Abilities.PORTAL_BEAST, Abilities.NONE, Abilities.NONE, 530, 70, 125, 75, 75, 75, 110, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.D_D_TRAINER, 20, false, false, false, "Duel Monster", Type.PSYCHIC, Type.FIGHTING, 1.0, 50.0, Abilities.PARALLEL_WORLD, Abilities.NONE, Abilities.NONE, 530, 95, 90, 75, 85, 80, 105, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.D_D_WARRIOR_LADY, 20, false, false, false, "Duel Monster", Type.FIGHTING, Type.PSYCHIC, 1.0, 50.0, Abilities.DIMENSION_SLASH, Abilities.NONE, Abilities.NONE, 530, 80, 90, 120, 60, 70, 110, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.DANDYLION, 20, false, false, false, "Duel Monster", Type.GRASS, Type.FAIRY, 1.0, 50.0, Abilities.COTTON_TOKENS, Abilities.NONE, Abilities.NONE, 500, 80, 65, 65, 100, 75, 115, 45, 50, 250, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.DANGER_BIGFOOT, 20, false, false, false, "Duel Monster", Type.GROUND, Type.GRASS, 1.0, 50.0, Abilities.DANGER_DISCARD, Abilities.NONE, Abilities.NONE, 560, 110, 130, 95, 55, 90, 80, 30, 50, 280, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.DARK_ERADICATOR_WARLOCK, 20, true, false, false, "Duel Monster", Type.FIRE, Type.PSYCHIC, 1.0, 50.0, Abilities.ERADICATORS_DOMAIN, Abilities.NONE, Abilities.NONE, 570, 90, 75, 85, 140, 100, 80, 15, 50, 285, GrowthRate.MEDIUM_SLOW, null, false),
        new PokemonSpecies(Species.DARK_EYES_ILLUSIONIST, 20, false, false, false, "Duel Monster", Type.DARK, Type.GHOST, 1.0, 50.0, Abilities.MIND_TRANCE, Abilities.NONE, Abilities.NONE, 500, 75, 50, 70, 110, 95, 100, 45, 50, 250, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.DARK_MAGICIAN, 20, true, false, false, "Duel Monster", Type.DARK, Type.PSYCHIC, 1.0, 50.0, Abilities.MASTER_OF_ILLUSIONS, Abilities.NONE, Abilities.NONE, 570, 95, 55, 95, 125, 110, 90, 15, 50, 285, GrowthRate.MEDIUM_SLOW, null, false),
        new PokemonSpecies(Species.DARK_MAGICIAN_VARIANT_2, 20, false, false, true, "Duel Monster", Type.PSYCHIC, Type.DARK, 1.0, 50.0, Abilities.MASTER_OF_THE_DARK_ARTS, Abilities.NONE, Abilities.NONE, 580, 80, 70, 80, 140, 110, 100, 15, 50, 290, GrowthRate.SLOW, null, false),
        new PokemonSpecies(Species.DARK_MAGICIAN_GIRL_ALTERNATE, 20, false, false, false, "Duel Monster", Type.PSYCHIC, Type.FAIRY, 1.0, 50.0, Abilities.MAGICAL_INHERITANCE, Abilities.NONE, Abilities.NONE, 540, 90, 50, 80, 110, 115, 95, 30, 50, 270, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.DARK_NECROFEAR, 20, false, false, false, "Duel Monster", Type.GHOST, Type.DARK, 1.0, 50.0, Abilities.CURSED_POSSESSION, Abilities.NONE, Abilities.NONE, 550, 95, 70, 100, 110, 130, 45, 30, 50, 275, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.DARK_PALADIN, 20, false, true, false, "Duel Monster", Type.PSYCHIC, Type.DRAGON, 1.0, 50.0, Abilities.SPELL_DRAIN, Abilities.NONE, Abilities.NONE, 620, 90, 125, 95, 130, 95, 85, 15, 50, 310, GrowthRate.FLUCTUATING, null, false),
        new PokemonSpecies(Species.DARK_RESONATOR, 20, false, false, false, "Duel Monster", Type.DARK, Type.NORMAL, 1.0, 50.0, Abilities.DARK_SOUNDWAVE, Abilities.NONE, Abilities.NONE, 530, 90, 50, 80, 115, 80, 115, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.DARK_RABBIT, 20, false, false, false, "Duel Monster", Type.FAIRY, Type.DARK, 1.0, 50.0, Abilities.MOONLIT_MISCHIEF, Abilities.NONE, Abilities.NONE, 530, 80, 95, 95, 65, 65, 130, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.DARK_RULER_HA_DES, 20, false, false, false, "Duel Monster", Type.POISON, Type.DARK, 1.0, 50.0, Abilities.SOUL_TAX, Abilities.NONE, Abilities.NONE, 550, 80, 90, 100, 130, 85, 65, 30, 50, 275, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.DARK_SAGE, 20, false, false, true, "Duel Monster", Type.PSYCHIC, Type.DARK, 1.0, 50.0, Abilities.TIMELINE_MAGIC, Abilities.NONE, Abilities.NONE, 590, 90, 55, 120, 120, 150, 55, 15, 50, 295, GrowthRate.SLOW, null, false),
        new PokemonSpecies(Species.DARK_WORLD_THORNS, 20, false, false, false, "Duel Monster", Type.DARK, Type.GRASS, 1.0, 50.0, Abilities.UNDERWORLD_THICKET, Abilities.NONE, Abilities.NONE, 520, 95, 95, 110, 85, 100, 35, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.DARKFIRE_DRAGON, 20, false, false, false, "Duel Monster", Type.DARK, Type.FIRE, 1.0, 50.0, Abilities.SHADOW_FLAME, Abilities.NONE, Abilities.NONE, 530, 80, 85, 70, 125, 65, 105, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.DESPAIR_FROM_THE_DARK, 20, false, false, false, "Duel Monster", Type.GHOST, Type.DARK, 1.0, 50.0, Abilities.ZOMBIE_COLOSSUS, Abilities.NONE, Abilities.NONE, 560, 100, 125, 90, 100, 85, 60, 30, 50, 280, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.DESTINY_HERO_DEFENDER, 20, false, false, false, "Duel Monster", Type.DARK, Type.FIGHTING, 1.0, 50.0, Abilities.ULTIMATE_DEFENSE, Abilities.NONE, Abilities.NONE, 540, 105, 70, 180, 70, 100, 15, 30, 50, 270, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.DESTINY_HERO_PLASMA, 20, false, false, true, "Duel Monster", Type.DARK, Type.DRAGON, 1.0, 50.0, Abilities.PLASMAS_DOMAIN, Abilities.NONE, Abilities.NONE, 580, 85, 120, 85, 90, 80, 120, 15, 50, 290, GrowthRate.SLOW, null, false),
        new PokemonSpecies(Species.DRAGON_DESTROYER_SWORDSMAN, 20, false, false, true, "Duel Monster", Type.STEEL, Type.FIGHTING, 1.0, 50.0, Abilities.DRAGONBANE_WRATH, Abilities.NONE, Abilities.NONE, 580, 90, 145, 100, 65, 85, 95, 15, 50, 290, GrowthRate.SLOW, null, false),
        new PokemonSpecies(Species.DRAGON_SPIRIT_OF_WHITE, 20, false, false, false, "Duel Monster", Type.FLYING, Type.DRAGON, 1.0, 50.0, Abilities.ETHEREAL_LIGHT, Abilities.NONE, Abilities.NONE, 560, 95, 80, 95, 100, 95, 95, 30, 50, 280, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.DRAGON_ZOMBIE, 20, false, false, false, "Duel Monster", Type.GHOST, Type.DRAGON, 1.0, 50.0, Abilities.PLAGUE_BREATHE, Abilities.NONE, Abilities.NONE, 540, 90, 120, 90, 100, 80, 60, 30, 50, 270, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.DRILLAGO, 20, false, false, false, "Duel Monster", Type.STEEL, Type.GROUND, 1.0, 50.0, Abilities.HEAVEN_PIERCER, Abilities.NONE, Abilities.NONE, 520, 95, 120, 90, 45, 65, 105, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.DUOTERION, 20, false, false, false, "Duel Monster", Type.WATER, Type.FIRE, 1.0, 50.0, Abilities.CLIMATE_CHANGE, Abilities.NONE, Abilities.NONE, 540, 100, 55, 60, 140, 70, 115, 30, 50, 270, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.EARTHBOUND_IMMORTAL_CHACU_CHALLHUA, 20, false, true, false, "Duel Monster", Type.WATER, Type.GROUND, 1.0, 50.0, Abilities.EARTHBOUND_CURSE, Abilities.NONE, Abilities.NONE, 600, 120, 120, 95, 120, 95, 50, 15, 50, 300, GrowthRate.FLUCTUATING, null, false),
        new PokemonSpecies(Species.EGYPTIAN_GOD_SLIME, 20, true, false, false, "Duel Monster", Type.WATER, Type.STELLAR, 1.0, 50.0, Abilities.IMMORTAL_SLIME, Abilities.NONE, Abilities.NONE, 570, 135, 105, 105, 105, 105, 15, 15, 50, 285, GrowthRate.MEDIUM_SLOW, null, false),
        new PokemonSpecies(Species.ELEMENTAL_HERO_BLADEDGE, 20, false, false, false, "Duel Monster", Type.STEEL, Type.FIGHTING, 1.0, 50.0, Abilities.GOLDEN_CLUTCH, Abilities.NONE, Abilities.NONE, 550, 85, 135, 100, 50, 80, 100, 30, 50, 275, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.ELEMENTAL_HERO_BURSTINATRIX, 20, false, false, false, "Duel Monster", Type.FIRE, Type.FIGHTING, 1.0, 50.0, Abilities.SCORCHING_BURSTER, Abilities.NONE, Abilities.NONE, 520, 75, 90, 75, 110, 75, 95, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.ELEMENTAL_HERO_CLAYMAN, 20, false, false, false, "Duel Monster", Type.GROUND, Type.FIGHTING, 1.0, 50.0, Abilities.CLAY_COLOSSUS, Abilities.NONE, Abilities.NONE, 520, 90, 105, 120, 40, 95, 70, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.ELEMENTAL_HERO_FLAME_WINGMAN, 20, true, false, false, "Duel Monster", Type.FIRE, Type.FLYING, 1.0, 50.0, Abilities.SCORCHING_JUSTICE, Abilities.NONE, Abilities.NONE, 570, 80, 115, 80, 115, 75, 105, 15, 50, 285, GrowthRate.MEDIUM_SLOW, null, false),
        new PokemonSpecies(Species.ELEMENTAL_HERO_NECROSHADE, 20, false, false, false, "Duel Monster", Type.GHOST, Type.FIGHTING, 1.0, 50.0, Abilities.SHADOW_MARTYR, Abilities.NONE, Abilities.NONE, 540, 75, 120, 80, 75, 75, 115, 30, 50, 270, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.ELEMENTAL_HERO_NEOS_ALT_MASTER_DUEL, 20, false, false, true, "Duel Monster", Type.PSYCHIC, Type.FIGHTING, 1.0, 50.0, Abilities.ALMIGHTY_GALAXY, Abilities.NONE, Abilities.NONE, 590, 90, 135, 90, 85, 85, 105, 15, 50, 295, GrowthRate.SLOW, null, false),
        new PokemonSpecies(Species.ELEMENTAL_HERO_NEOS_ALIUS, 20, false, false, false, "Duel Monster", Type.FIGHTING, Type.PSYCHIC, 1.0, 50.0, Abilities.GALACTIC_AWAKENING, Abilities.NONE, Abilities.NONE, 520, 80, 110, 80, 75, 75, 100, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.ELEMENTAL_HERO_SPARKMAN, 20, false, false, false, "Duel Monster", Type.ELECTRIC, Type.FIGHTING, 1.0, 50.0, Abilities.STATIC_SHOCK, Abilities.NONE, Abilities.NONE, 550, 75, 100, 75, 110, 75, 115, 30, 50, 275, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.ELEMENTAL_HERO_STRATOS, 20, false, false, false, "Duel Monster", Type.FLYING, Type.FIGHTING, 1.0, 50.0, Abilities.CYCLONE_FIST, Abilities.NONE, Abilities.NONE, 540, 80, 105, 80, 85, 75, 115, 30, 50, 270, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.ENRAGED_BATTLE_OX, 20, false, false, false, "Duel Monster", Type.GRASS, Type.STEEL, 1.0, 50.0, Abilities.BLIND_RAGE, Abilities.NONE, Abilities.NONE, 540, 90, 145, 85, 35, 65, 120, 30, 50, 270, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.EVILSWARM_MANDRAGORA, 20, false, false, false, "Duel Monster", Type.DARK, Type.GRASS, 1.0, 50.0, Abilities.VILE_OVERGROWTH, Abilities.NONE, Abilities.NONE, 520, 90, 95, 80, 95, 70, 90, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.EVILSWARM_SALAMANDRA, 20, false, false, false, "Duel Monster", Type.DARK, Type.DRAGON, 1.0, 50.0, Abilities.NECRO_SURGE, Abilities.NONE, Abilities.NONE, 530, 85, 130, 70, 65, 60, 120, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.EXODIA_FULL_BODY, 20, false, true, false, "Duel Monster", Type.DARK, Type.PSYCHIC, 1.0, 50.0, Abilities.UNCONTROLLABLE_POWER, Abilities.NONE, Abilities.NONE, 700, 120, 120, 120, 140, 120, 80, 5, 50, 350, GrowthRate.FLUCTUATING, null, false),
        new PokemonSpecies(Species.EXODIA_NECROSS, 20, false, true, false, "Duel Monster", Type.GHOST, Type.DARK, 1.0, 50.0, Abilities.ABSOLUTE_VOID_MAGIC, Abilities.NONE, Abilities.NONE, 700, 110, 150, 105, 140, 95, 100, 5, 50, 350, GrowthRate.FLUCTUATING, null, false),
        new PokemonSpecies(Species.EXODIA_THE_FORBIDDEN_EVOLUTION, 20, false, true, false, "Duel Monster", Type.PSYCHIC, Type.DARK, 1.0, 50.0, Abilities.CHAINS_OF_INFINITY, Abilities.NONE, Abilities.NONE, 720, 115, 140, 105, 160, 110, 90, 5, 50, 360, GrowthRate.FLUCTUATING, null, false),
        new PokemonSpecies(Species.EXODIUS_THE_ULTIMATE_FORBIDDEN_LORD, 20, false, true, false, "Duel Monster", Type.PSYCHIC, Type.FIGHTING, 1.0, 50.0, Abilities.FORBIDDEN_POWER, Abilities.NONE, Abilities.NONE, 600, 100, 100, 100, 100, 100, 100, 15, 50, 300, GrowthRate.FLUCTUATING, null, false),
        new PokemonSpecies(Species.FENRIR, 20, false, false, false, "Duel Monster", Type.ICE, Type.WATER, 1.0, 50.0, Abilities.BEAST_OF_RAGNAROK, Abilities.NONE, Abilities.NONE, 530, 85, 125, 80, 60, 70, 110, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.FERAL_IMP, 20, false, false, false, "Duel Monster", Type.DARK, Type.FAIRY, 1.0, 50.0, Abilities.NIGHT_STALKER, Abilities.NONE, Abilities.NONE, 520, 90, 90, 100, 75, 75, 90, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.FIEND_KRAKEN, 20, false, false, false, "Duel Monster", Type.WATER, Type.DARK, 1.0, 50.0, Abilities.ABYSSAL_GRASP, Abilities.NONE, Abilities.NONE, 550, 80, 115, 75, 115, 75, 90, 30, 50, 275, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.FIEND_SWORD, 20, false, false, false, "Duel Monster", Type.DARK, Type.STEEL, 1.0, 50.0, Abilities.DEMONIC_EDGE, Abilities.NONE, Abilities.NONE, 515, 75, 125, 85, 55, 65, 110, 30, 50, 258, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.FOSSIL_DYNA_PACHYCEPHALO, 20, false, false, false, "Duel Monster", Type.ROCK, Type.DRAGON, 1.0, 50.0, Abilities.FOSSIL_BARRIER, Abilities.NONE, Abilities.NONE, 520, 75, 115, 110, 40, 70, 110, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.FOSSIL_WARRIOR_SKULL_KING, 20, true, false, false, "Duel Monster", Type.ROCK, Type.GHOST, 1.0, 50.0, Abilities.DUAL_BONE_BLADE, Abilities.NONE, Abilities.NONE, 570, 85, 135, 100, 55, 80, 115, 15, 50, 285, GrowthRate.MEDIUM_SLOW, null, false),
        new PokemonSpecies(Species.FROST_FLAME_DRAGON, 20, false, false, false, "Duel Monster", Type.ICE, Type.FIRE, 1.0, 50.0, Abilities.FIRE_AND_ICE, Abilities.NONE, Abilities.NONE, 560, 85, 95, 80, 130, 75, 95, 30, 50, 280, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.FROSTOSAURUS, 20, false, false, false, "Duel Monster", Type.ICE, Type.ROCK, 1.0, 50.0, Abilities.ICE_AGE, Abilities.NONE, Abilities.NONE, 540, 90, 155, 100, 50, 75, 70, 30, 50, 270, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.GAGAGIGO, 20, false, false, false, "Duel Monster", Type.DARK, Type.WATER, 1.0, 50.0, Abilities.SCALES_OF_JUSTICE, Abilities.NONE, Abilities.NONE, 540, 85, 140, 80, 60, 55, 120, 30, 50, 270, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.GAIA_THE_DRAGON_CHAMPION, 20, true, false, false, "Duel Monster", Type.DRAGON, Type.FLYING, 1.0, 50.0, Abilities.PIERCING_SPIRAL, Abilities.NONE, Abilities.NONE, 570, 85, 125, 90, 65, 80, 125, 15, 50, 285, GrowthRate.MEDIUM_SLOW, null, false),
        new PokemonSpecies(Species.GAIA_THE_FIERCE_KNIGHT, 20, false, false, false, "Duel Monster", Type.FIGHTING, Type.NORMAL, 1.0, 50.0, Abilities.CHARGE_CHAMPION, Abilities.NONE, Abilities.NONE, 540, 85, 135, 80, 50, 60, 130, 30, 50, 270, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.GAMMA_THE_MAGNET_WARRIOR, 20, false, false, false, "Duel Monster", Type.STEEL, Type.ROCK, 1.0, 50.0, Abilities.RADIATING_GAMMA, Abilities.NONE, Abilities.NONE, 530, 80, 90, 120, 90, 90, 60, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.GAZELLE_THE_KING_OF_MYTHICAL_BEASTS, 20, false, false, false, "Duel Monster", Type.FAIRY, Type.NORMAL, 1.0, 50.0, Abilities.PHANTOM_BEAST, Abilities.NONE, Abilities.NONE, 520, 70, 110, 70, 85, 85, 100, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.GELLENDUO, 20, false, false, false, "Duel Monster", Type.FAIRY, Type.FLYING, 1.0, 50.0, Abilities.TWIN_BLESSINGS, Abilities.NONE, Abilities.NONE, 520, 80, 30, 80, 120, 80, 130, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.GEM_KNIGHT_CITRINE, 20, false, false, false, "Duel Monster", Type.ROCK, Type.FIRE, 1.0, 50.0, Abilities.BLAZING_CITRINE, Abilities.NONE, Abilities.NONE, 550, 80, 125, 90, 105, 70, 80, 30, 50, 275, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.GEM_KNIGHT_MASTER_DIAMOND, 20, false, false, true, "Duel Monster", Type.ROCK, Type.STELLAR, 1.0, 50.0, Abilities.INFINITY_STONES, Abilities.NONE, Abilities.NONE, 590, 90, 135, 100, 105, 90, 70, 15, 50, 295, GrowthRate.SLOW, null, false),
        new PokemonSpecies(Species.GENEX_ALLY_BIRDMAN, 20, false, false, false, "Duel Monster", Type.ELECTRIC, Type.FLYING, 1.0, 50.0, Abilities.ROUND_TRIP, Abilities.NONE, Abilities.NONE, 520, 70, 90, 75, 80, 70, 135, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.GHOSTRICK_GHOUL, 20, false, false, false, "Duel Monster", Type.GHOST, Type.POISON, 1.0, 50.0, Abilities.CORPSE_PARTY, Abilities.NONE, Abilities.NONE, 520, 80, 115, 75, 85, 70, 95, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.GHOSTRICK_MUMMY, 20, false, false, false, "Duel Monster", Type.GHOST, Type.GROUND, 1.0, 50.0, Abilities.S_AND_MUMMY, Abilities.NONE, Abilities.NONE, 520, 115, 105, 105, 50, 90, 55, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.GHOSTRICK_SKELETON, 20, false, false, false, "Duel Monster", Type.DARK, Type.GHOST, 1.0, 50.0, Abilities.THE_GRIM_MILLER, Abilities.NONE, Abilities.NONE, 550, 110, 85, 65, 85, 80, 125, 30, 50, 275, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.GHOSTRICK_STEIN, 20, false, false, false, "Duel Monster", Type.ELECTRIC, Type.GHOST, 1.0, 50.0, Abilities.ELECTRO_BOOGEY, Abilities.NONE, Abilities.NONE, 540, 120, 125, 100, 70, 80, 45, 30, 50, 270, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.GHOSTRICK_YETI, 20, false, false, false, "Duel Monster", Type.ICE, Type.GHOST, 1.0, 50.0, Abilities.ABOMINABLE_PROTECTION, Abilities.NONE, Abilities.NONE, 540, 110, 100, 110, 80, 100, 40, 30, 50, 270, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.GIGA_GAGAGIGO, 20, false, false, false, "Duel Monster", Type.STEEL, Type.DARK, 1.0, 50.0, Abilities.CORRUPTED_POWER, Abilities.NONE, Abilities.NONE, 560, 90, 130, 90, 75, 75, 100, 30, 50, 280, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.GATE_GUARDIAN, 20, false, true, false, "Duel Monster", Type.STELLAR, null, 1.0, 50.0, Abilities.ELEMENTAL_HAVOC, Abilities.NONE, Abilities.NONE, 630, 100, 130, 100, 130, 100, 70, 5, 50, 315, GrowthRate.FLUCTUATING, null, false),
        new PokemonSpecies(Species.GIGOBYTE, 20, false, false, false, "Duel Monster", Type.WATER, Type.DRAGON, 1.0, 50.0, Abilities.ADVENTURE_START, Abilities.NONE, Abilities.NONE, 520, 75, 110, 80, 95, 75, 85, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.GOGIGA_GAGAGIGO, 20, false, true, false, "Duel Monster", Type.DARK, Type.DRAGON, 1.0, 50.0, Abilities.MINDLESS_RAMPAGE, Abilities.NONE, Abilities.NONE, 600, 85, 145, 95, 85, 80, 110, 15, 50, 300, GrowthRate.FLUCTUATING, null, false),
        new PokemonSpecies(Species.GOLDEN_EYES_IDOL, 20, false, false, false, "Duel Monster", Type.GHOST, Type.PSYCHIC, 1.0, 50.0, Abilities.GOLDEN_GAZE, Abilities.NONE, Abilities.NONE, 540, 85, 55, 90, 120, 95, 95, 30, 50, 270, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.GRAVEROBBER, 20, false, false, false, "Duel Monster", Type.DARK, Type.GROUND, 1.0, 50.0, Abilities.TOMB_RAIDER, Abilities.NONE, Abilities.NONE, 530, 85, 110, 70, 65, 65, 135, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.GREAT_MOTH, 20, false, false, false, "Duel Monster", Type.POISON, Type.BUG, 1.0, 50.0, Abilities.POWDER_KING, Abilities.NONE, Abilities.NONE, 550, 110, 70, 75, 130, 85, 80, 30, 50, 275, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.GREAT_WHITE, 20, false, false, false, "Duel Monster", Type.WATER, Type.NORMAL, 1.0, 50.0, Abilities.BLOOD_SCENT, Abilities.NONE, Abilities.NONE, 520, 80, 140, 60, 65, 60, 115, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.GREEN_BABOON_DEFENDER_OF_THE_FOREST, 20, false, false, false, "Duel Monster", Type.GRASS, Type.FIGHTING, 1.0, 50.0, Abilities.UNITED_JUNGLE, Abilities.NONE, Abilities.NONE, 550, 130, 120, 90, 60, 70, 80, 30, 50, 275, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.GREEN_GADGET, 20, false, false, false, "Duel Monster", Type.GRASS, Type.STEEL, 1.0, 50.0, Abilities.EMERALD_GEAR, Abilities.NONE, Abilities.NONE, 520, 90, 85, 80, 110, 80, 75, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.GRIFFORE, 20, false, false, false, "Duel Monster", Type.GROUND, Type.FLYING, 1.0, 50.0, Abilities.DEFLECTION_HIDE, Abilities.NONE, Abilities.NONE, 510, 120, 95, 105, 50, 70, 70, 30, 50, 255, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.GUARDIAN_GRARL, 20, false, false, false, "Duel Monster", Type.GROUND, Type.DRAGON, 1.0, 50.0, Abilities.GRAVITY_AXE, Abilities.NONE, Abilities.NONE, 530, 90, 135, 95, 50, 75, 85, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.HADE_HANE, 20, false, false, false, "Duel Monster", Type.FLYING, Type.FAIRY, 1.0, 50.0, Abilities.REBOUNDING_HURRICANE, Abilities.NONE, Abilities.NONE, 550, 100, 85, 70, 85, 70, 140, 30, 50, 275, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.HANE_HANE, 20, false, false, false, "Duel Monster", Type.FLYING, Type.FAIRY, 1.0, 50.0, Abilities.WHIRLWIND_AXE, Abilities.NONE, Abilities.NONE, 500, 80, 85, 50, 85, 60, 140, 45, 50, 250, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.HARPIES_PET_DRAGON, 20, false, false, false, "Duel Monster", Type.DRAGON, Type.FLYING, 1.0, 50.0, Abilities.HARPIE_BOOST, Abilities.NONE, Abilities.NONE, 560, 100, 90, 115, 90, 90, 75, 30, 50, 280, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.HEADLESS_KNIGHT, 20, false, false, false, "Duel Monster", Type.GHOST, Type.STEEL, 1.0, 50.0, Abilities.PHANTOM_ARMOR, Abilities.NONE, Abilities.NONE, 530, 105, 110, 125, 55, 85, 50, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.HITOTSU_ME_GIANT, 20, false, false, false, "Duel Monster", Type.NORMAL, null, 1.0, 50.0, Abilities.GIANT_IMPACT, Abilities.NONE, Abilities.NONE, 530, 135, 120, 95, 45, 65, 70, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.HUMANOID_SLIME, 20, false, false, false, "Duel Monster", Type.WATER, Type.POISON, 1.0, 50.0, Abilities.SLIME_ABSORB, Abilities.NONE, Abilities.NONE, 510, 85, 85, 100, 85, 80, 75, 30, 50, 255, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.HUNDRED_EYES_DRAGON, 20, false, false, true, "Duel Monster", Type.GHOST, Type.DRAGON, 1.0, 50.0, Abilities.THOUSAND_SOULS, Abilities.NONE, Abilities.NONE, 585, 85, 115, 90, 120, 90, 85, 15, 50, 292, GrowthRate.SLOW, null, false),
        new PokemonSpecies(Species.HUNGRY_BURGER, 20, false, false, false, "Duel Monster", Type.DARK, Type.GROUND, 1.0, 50.0, Abilities.FAST_FOOD, Abilities.NONE, Abilities.NONE, 530, 105, 140, 80, 55, 80, 70, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.HYDROGEDDON, 20, false, false, false, "Duel Monster", Type.WATER, Type.DRAGON, 1.0, 50.0, Abilities.HYDRO_CLONE, Abilities.NONE, Abilities.NONE, 530, 90, 115, 80, 75, 65, 105, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.HYOZANRYU, 20, false, false, false, "Duel Monster", Type.ICE, Type.DRAGON, 1.0, 50.0, Abilities.CRYSTAL_LUSTER, Abilities.NONE, Abilities.NONE, 560, 90, 70, 110, 90, 110, 90, 30, 50, 280, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.HYPER_HAMMERHEAD, 20, false, false, false, "Duel Monster", Type.GROUND, Type.ROCK, 1.0, 50.0, Abilities.HAMMER_KNOCKBACK, Abilities.NONE, Abilities.NONE, 530, 80, 120, 90, 40, 70, 130, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.ILLUSIONIST_FACELESS_MAGE, 20, false, false, false, "Duel Monster", Type.PSYCHIC, Type.GHOST, 1.0, 50.0, Abilities.MIND_WARP, Abilities.NONE, Abilities.NONE, 540, 100, 50, 70, 110, 130, 80, 30, 50, 270, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.JINZO_THE_MACHINE_MENACE, 20, false, false, false, "Duel Monster", Type.PSYCHIC, Type.ELECTRIC, 1.0, 50.0, Abilities.CYBERNETIC_CONTROL, Abilities.NONE, Abilities.NONE, 560, 85, 80, 80, 125, 80, 110, 30, 50, 280, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.JUNK_WARRIOR, 20, false, false, false, "Duel Monster", Type.STEEL, Type.FIGHTING, 1.0, 50.0, Abilities.JUNK_TO_TREASURE, Abilities.NONE, Abilities.NONE, 520, 85, 105, 85, 80, 85, 80, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.KAZEJIN, 20, true, false, false, "Duel Monster", Type.FLYING, Type.STEEL, 1.0, 50.0, Abilities.CYCLONE_WRATH, Abilities.NONE, Abilities.NONE, 570, 85, 85, 100, 125, 100, 75, 15, 50, 285, GrowthRate.MEDIUM_SLOW, null, false),
        new PokemonSpecies(Species.KING_OF_THE_SKULL_SERVANTS, 20, false, false, true, "Duel Monster", Type.GHOST, Type.GROUND, 1.0, 50.0, Abilities.THE_UNDEAD_KING, Abilities.NONE, Abilities.NONE, 580, 75, 115, 80, 115, 75, 120, 15, 50, 290, GrowthRate.SLOW, null, false),
        new PokemonSpecies(Species.KOITSU, 20, false, false, false, "Duel Monster", Type.FLYING, Type.WATER, 1.0, 50.0, Abilities.TRAVEL_BUDDIES_BLUE, Abilities.NONE, Abilities.NONE, 500, 100, 80, 70, 80, 70, 100, 45, 50, 250, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.KOZAKY, 20, false, false, false, "Duel Monster", Type.DARK, Type.POISON, 1.0, 50.0, Abilities.FOR_SCIENCE, Abilities.NONE, Abilities.NONE, 520, 95, 85, 70, 105, 70, 95, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.KURIBOH, 20, false, false, false, "Duel Monster", Type.FAIRY, Type.DARK, 1.0, 50.0, Abilities.MULTIPLY, Abilities.NONE, Abilities.NONE, 500, 70, 85, 80, 85, 80, 100, 45, 50, 250, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.LA_JINN_THE_MYSTICAL_GENIE, 20, false, false, false, "Duel Monster", Type.FAIRY, Type.GHOST, 1.0, 50.0, Abilities.GENIE_MAGIC, Abilities.NONE, Abilities.NONE, 540, 80, 100, 75, 115, 80, 90, 30, 50, 270, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.LAVA_GOLEM, 20, false, false, false, "Duel Monster", Type.FIRE, Type.GROUND, 1.0, 50.0, Abilities.MOLTEN_SHACKLES, Abilities.NONE, Abilities.NONE, 560, 110, 90, 120, 110, 100, 30, 30, 50, 280, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.LEGENDARY_SWORDSMAN, 20, false, false, true, "Duel Monster", Type.FIGHTING, Type.NORMAL, 1.0, 50.0, Abilities.MASTERS_BLADE, Abilities.NONE, Abilities.NONE, 590, 90, 115, 90, 70, 90, 135, 15, 50, 295, GrowthRate.SLOW, null, false),
        new PokemonSpecies(Species.LEVIA_DRAGON_DAEDALUS, 20, true, false, false, "Duel Monster", Type.WATER, Type.DRAGON, 1.0, 50.0, Abilities.LEVIATHANS_WRATH, Abilities.NONE, Abilities.NONE, 570, 85, 100, 85, 130, 85, 85, 15, 50, 285, GrowthRate.MEDIUM_SLOW, null, false),
        new PokemonSpecies(Species.LORD_OF_D, 20, false, false, false, "Duel Monster", Type.DRAGON, Type.NORMAL, 1.0, 50.0, Abilities.DRACONIC_FLUTE, Abilities.NONE, Abilities.NONE, 530, 95, 80, 95, 85, 100, 75, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.MAGICIANS_ROBE, 20, false, false, false, "Duel Monster", Type.PSYCHIC, Type.FAIRY, 1.0, 50.0, Abilities.ILLUSION_WEAVER, Abilities.NONE, Abilities.NONE, 500, 75, 60, 85, 95, 110, 75, 45, 50, 250, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.MAGIKURIBOH, 20, false, false, false, "Duel Monster", Type.PSYCHIC, Type.FAIRY, 1.0, 50.0, Abilities.SPELLCASTERS_FLUFF, Abilities.NONE, Abilities.NONE, 560, 90, 80, 80, 130, 60, 120, 30, 50, 280, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.MASKED_BEAST_DES_GARDIUS, 20, true, false, false, "Duel Monster", Type.DARK, Type.GHOST, 1.0, 50.0, Abilities.MASK_OF_REMNANTS, Abilities.NONE, Abilities.NONE, 570, 90, 140, 95, 85, 80, 80, 15, 50, 285, GrowthRate.MEDIUM_SLOW, null, false),
        new PokemonSpecies(Species.MASTER_OF_OZ, 20, false, false, false, "Duel Monster", Type.FIGHTING, Type.GROUND, 1.0, 50.0, Abilities.HEAVYWEIGHT_HOPPER, Abilities.NONE, Abilities.NONE, 560, 120, 155, 95, 50, 75, 65, 30, 50, 280, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.METEOR_B_DRAGON, 20, false, true, false, "Duel Monster", Type.ROCK, Type.FIRE, 1.0, 50.0, Abilities.METEOR_SHOWER, Abilities.NONE, Abilities.NONE, 600, 90, 140, 110, 120, 80, 60, 15, 50, 300, GrowthRate.FLUCTUATING, null, false),
        new PokemonSpecies(Species.MILLENNIUM_SCORPION, 20, false, false, false, "Duel Monster", Type.BUG, Type.FAIRY, 1.0, 50.0, Abilities.MILLENNIUM_STALKER, Abilities.NONE, Abilities.NONE, 530, 85, 125, 85, 50, 65, 120, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.MILLENNIUM_SHIELD, 20, false, false, false, "Duel Monster", Type.ROCK, Type.PSYCHIC, 1.0, 50.0, Abilities.MILLENNIAL_WEAPON, Abilities.NONE, Abilities.NONE, 540, 100, 45, 180, 60, 140, 15, 30, 50, 270, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.MORPHING_JAR, 20, false, false, false, "Duel Monster", Type.ROCK, Type.DARK, 1.0, 50.0, Abilities.HAND_RESET, Abilities.NONE, Abilities.NONE, 520, 80, 95, 85, 95, 85, 80, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.MUKA_MUKA, 20, false, false, false, "Duel Monster", Type.GROUND, Type.PSYCHIC, 1.0, 50.0, Abilities.EXPANDING_MASS, Abilities.NONE, Abilities.NONE, 530, 100, 105, 90, 80, 75, 80, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.NUMBER_22_ZOMBIESTEIN, 20, false, false, false, "Duel Monster", Type.GHOST, Type.FIGHTING, 1.0, 50.0, Abilities.SMASH_22, Abilities.NONE, Abilities.NONE, 530, 100, 150, 100, 50, 70, 60, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.OBELISK_THE_TORMENTOR, 20, false, true, false, "Duel Monster", Type.FIGHTING, Type.STELLAR, 1.0, 50.0, Abilities.FIST_OF_FATE, Abilities.NONE, Abilities.NONE, 700, 120, 150, 120, 120, 120, 70, 5, 50, 350, GrowthRate.FLUCTUATING, null, false),
        new PokemonSpecies(Species.OCEAN_DRAGON_LORD_KAIRYU_SHIN, 20, false, true, false, "Duel Monster", Type.WATER, Type.DRAGON, 1.0, 50.0, Abilities.LEVIATHANS_DOMAIN, Abilities.NONE, Abilities.NONE, 610, 100, 120, 100, 130, 100, 60, 15, 50, 305, GrowthRate.FLUCTUATING, null, false),
        new PokemonSpecies(Species.OJAMA_BLACK_GREEN, 20, false, false, false, "Duel Monster", Type.NORMAL, Type.FAIRY, 1.0, 50.0, Abilities.OJAMA_MAGIC, Abilities.NONE, Abilities.NONE, 500, 100, 70, 85, 70, 80, 95, 45, 50, 250, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.OJAMA_KING, 20, true, false, false, "Duel Monster", Type.FAIRY, Type.NORMAL, 1.0, 50.0, Abilities.OJAMA_LOCKDOWN, Abilities.NONE, Abilities.NONE, 570, 120, 100, 130, 80, 120, 20, 15, 50, 285, GrowthRate.MEDIUM_SLOW, null, false),
        new PokemonSpecies(Species.OJAMA_KNIGHT, 20, false, false, false, "Duel Monster", Type.STEEL, Type.FAIRY, 1.0, 50.0, Abilities.OJAMA_SOLIDARITY, Abilities.NONE, Abilities.NONE, 550, 95, 105, 105, 65, 95, 85, 30, 50, 275, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.OVERTEX_QOATLUS, 20, false, false, true, "Duel Monster", Type.FLYING, Type.ROCK, 1.0, 50.0, Abilities.EVOLUTION_PILL, Abilities.NONE, Abilities.NONE, 580, 90, 135, 90, 80, 80, 105, 15, 50, 290, GrowthRate.SLOW, null, false),
        new PokemonSpecies(Species.OXYGEDDON, 20, false, false, false, "Duel Monster", Type.FLYING, Type.DRAGON, 1.0, 50.0, Abilities.EXPLOSIVE_AIR, Abilities.NONE, Abilities.NONE, 530, 75, 95, 70, 125, 65, 100, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.PALADIN_OF_THE_CURSED_DRAGON, 20, false, false, false, "Duel Monster", Type.GHOST, Type.DRAGON, 1.0, 50.0, Abilities.NECRO_DRAIN, Abilities.NONE, Abilities.NONE, 530, 75, 115, 80, 75, 70, 115, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.PALADIN_OF_WHITE_DRAGON, 20, false, false, false, "Duel Monster", Type.DRAGON, Type.ELECTRIC, 1.0, 50.0, Abilities.DRACO_LANCE, Abilities.NONE, Abilities.NONE, 540, 95, 90, 95, 80, 90, 90, 30, 50, 270, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.PANTHER_WARRIOR, 20, false, false, false, "Duel Monster", Type.DARK, Type.FIGHTING, 1.0, 50.0, Abilities.BEASTSTAR, Abilities.NONE, Abilities.NONE, 520, 85, 130, 70, 50, 55, 130, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.PANZER_DRAGON, 20, false, false, false, "Duel Monster", Type.STEEL, Type.DRAGON, 1.0, 50.0, Abilities.RAPID_FIRE, Abilities.NONE, Abilities.NONE, 560, 80, 110, 90, 110, 80, 90, 30, 50, 280, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.PAPA_CORN, 20, false, false, false, "Duel Monster", Type.GRASS, Type.FAIRY, 1.0, 50.0, Abilities.CORNFIELD_GUARDIAN, Abilities.NONE, Abilities.NONE, 530, 85, 100, 80, 80, 85, 100, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.PLAGUESPREADER_ZOMBIE, 20, false, false, false, "Duel Monster", Type.POISON, Type.GHOST, 1.0, 50.0, Abilities.CONTAGION, Abilities.NONE, Abilities.NONE, 510, 70, 105, 65, 80, 70, 120, 30, 50, 255, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.QUICKDRAW_SYNCHRON, 20, false, false, false, "Duel Monster", Type.STEEL, null, 1.0, 50.0, Abilities.QUICK_DRAW_V2, Abilities.NONE, Abilities.NONE, 540, 100, 85, 60, 80, 55, 160, 30, 50, 270, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.RELINQUISHED, 20, false, false, false, "Duel Monster", Type.DARK, Type.GHOST, 1.0, 50.0, Abilities.MILLENNIUM_ABSORPTION, Abilities.NONE, Abilities.NONE, 560, 85, 70, 85, 130, 85, 105, 30, 50, 280, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.SNOWMAN_EATER, 20, false, false, false, "Duel Monster", Type.ICE, Type.DARK, 1.0, 50.0, Abilities.FROSTY_ABOMINATION, Abilities.NONE, Abilities.NONE, 530, 80, 100, 160, 55, 70, 65, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.SOLDIER_OF_CHAOS, 20, false, false, true, "Duel Monster", Type.DARK, Type.FIGHTING, 1.0, 50.0, Abilities.CHAOS_ORDER, Abilities.NONE, Abilities.NONE, 580, 90, 130, 95, 75, 85, 105, 15, 50, 290, GrowthRate.SLOW, null, false),
        new PokemonSpecies(Species.SOUL_HUNTER, 20, false, false, false, "Duel Monster", Type.DARK, Type.GHOST, 1.0, 50.0, Abilities.SOUL_EATER, Abilities.NONE, Abilities.NONE, 540, 80, 125, 85, 75, 70, 105, 30, 50, 270, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.SPEED_WARRIOR, 20, false, false, false, "Duel Monster", Type.STEEL, Type.NORMAL, 1.0, 50.0, Abilities.MACH_SPEED, Abilities.NONE, Abilities.NONE, 520, 85, 95, 80, 40, 80, 140, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.STEEL_OGRE_GROTTO_1, 20, false, false, false, "Duel Monster", Type.STEEL, Type.GROUND, 1.0, 50.0, Abilities.IRON_GIANT, Abilities.NONE, Abilities.NONE, 520, 110, 110, 130, 50, 90, 30, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.SUIJIN, 20, true, false, false, "Duel Monster", Type.WATER, Type.PSYCHIC, 1.0, 50.0, Abilities.TORRENTIAL_TRIBUTE, Abilities.NONE, Abilities.NONE, 570, 85, 70, 100, 130, 100, 85, 15, 50, 285, GrowthRate.MEDIUM_SLOW, null, false),
        new PokemonSpecies(Species.YELLOW_GADGET, 20, false, false, false, "Duel Monster", Type.ELECTRIC, Type.STEEL, 1.0, 50.0, Abilities.GOLDEN_GEAR, Abilities.NONE, Abilities.NONE, 520, 85, 60, 60, 105, 75, 135, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.SUPREME_KING_OF_ARMAGEDDON, 20, false, false, true, "Duel Monster", Type.DARK, Type.STEEL, 1.0, 50.0, Abilities.RUIN, Abilities.NONE, Abilities.NONE, 580, 100, 140, 95, 85, 80, 80, 15, 50, 290, GrowthRate.SLOW, null, false),
        new PokemonSpecies(Species.THE_CREATOR, 20, false, false, true, "Duel Monster", Type.ELECTRIC, Type.FAIRY, 1.0, 50.0, Abilities.LIFE_EXCHANGE, Abilities.NONE, Abilities.NONE, 580, 100, 60, 95, 105, 140, 80, 15, 50, 290, GrowthRate.SLOW, null, false),
        new PokemonSpecies(Species.THE_FABLED_CERBURREL, 20, false, false, false, "Duel Monster", Type.DARK, Type.FAIRY, 1.0, 50.0, Abilities.THREE_HEADED_BITE, Abilities.NONE, Abilities.NONE, 510, 85, 110, 70, 60, 70, 115, 30, 50, 255, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.THE_FABLED_GANASHIA, 20, false, false, false, "Duel Monster", Type.ICE, Type.FAIRY, 1.0, 50.0, Abilities.CORRUPT_ELEPHANT, Abilities.NONE, Abilities.NONE, 530, 100, 135, 75, 50, 75, 95, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.THE_TRICKY, 20, false, false, false, "Duel Monster", Type.PSYCHIC, Type.GHOST, 1.0, 50.0, Abilities.ILLUSIONIST, Abilities.NONE, Abilities.NONE, 530, 70, 70, 65, 120, 75, 130, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.THE_MASKED_BEAST, 20, false, false, false, "Duel Monster", Type.DARK, Type.POISON, 1.0, 50.0, Abilities.MASKED_GOD, Abilities.NONE, Abilities.NONE, 560, 80, 155, 100, 85, 85, 55, 30, 50, 280, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.THOUSAND_DRAGON, 20, false, false, false, "Duel Monster", Type.DRAGON, Type.FIRE, 1.0, 50.0, Abilities.THOUSAND_YEARS, Abilities.NONE, Abilities.NONE, 560, 120, 85, 80, 140, 75, 60, 30, 50, 280, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.THOUSAND_EYES_RESTRICT, 20, false, false, true, "Duel Monster", Type.DARK, Type.GHOST, 1.0, 50.0, Abilities.THOUSAND_EYES_LOCK, Abilities.NONE, Abilities.NONE, 580, 85, 75, 95, 135, 110, 80, 15, 50, 290, GrowthRate.SLOW, null, false),
        new PokemonSpecies(Species.TIME_WIZARD_OF_TOMORROW, 20, false, false, false, "Duel Monster", Type.PSYCHIC, Type.FAIRY, 1.0, 50.0, Abilities.TIME_ROULETTE, Abilities.NONE, Abilities.NONE, 530, 75, 55, 75, 120, 90, 115, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.TOGEX, 20, false, false, false, "Duel Monster", Type.STEEL, Type.GRASS, 1.0, 50.0, Abilities.SPIKED_SHELL, Abilities.NONE, Abilities.NONE, 530, 90, 90, 105, 60, 90, 95, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.YUBEL, 20, false, false, false, "Duel Monster", Type.DARK, Type.POISON, 1.0, 50.0, Abilities.TWISTED_LOVE, Abilities.NONE, Abilities.NONE, 560, 140, 80, 90, 80, 90, 80, 30, 50, 280, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.ZOMBYRA_THE_DARK, 20, false, false, false, "Duel Monster", Type.DARK, Type.FIGHTING, 1.0, 50.0, Abilities.CURSED_POTENTIAL, Abilities.NONE, Abilities.NONE, 500, 65, 135, 70, 45, 55, 130, 45, 50, 250, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.WOODLAND_SPRITE, 20, false, false, false, "Duel Monster", Type.GRASS, Type.FAIRY, 1.0, 50.0, Abilities.FOREST_TRICKERY, Abilities.NONE, Abilities.NONE, 520, 100, 40, 75, 110, 75, 120, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.WATER_DRAGON, 20, false, false, false, "Duel Monster", Type.WATER, Type.DRAGON, 1.0, 50.0, Abilities.HYDRO_SURGE, Abilities.NONE, Abilities.NONE, 560, 85, 80, 90, 145, 85, 75, 30, 50, 280, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.WATER_DRAGON_CLUSTER, 20, false, true, false, "Duel Monster", Type.WATER, Type.DRAGON, 1.0, 50.0, Abilities.CLUSTER_BURST, Abilities.NONE, Abilities.NONE, 600, 105, 100, 105, 125, 100, 65, 15, 50, 300, GrowthRate.FLUCTUATING, null, false),
        new PokemonSpecies(Species.VOLCANIC_SHELL, 20, false, false, false, "Duel Monster", Type.FIRE, Type.STEEL, 1.0, 50.0, Abilities.PYRO_BULLET, Abilities.NONE, Abilities.NONE, 510, 75, 85, 70, 85, 75, 120, 30, 50, 255, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.TOON_ALLIGATOR, 20, false, false, false, "Duel Monster", Type.WATER, Type.FAIRY, 1.0, 50.0, Abilities.ZANY_SPLASHER, Abilities.NONE, Abilities.NONE, 530, 85, 110, 75, 50, 65, 145, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.TOON_ANCIENT_GEAR_GOLEM, 20, false, false, false, "Duel Monster", Type.FAIRY, Type.STEEL, 1.0, 50.0, Abilities.TOON_POUNDING, Abilities.NONE, Abilities.NONE, 550, 95, 135, 110, 50, 80, 80, 30, 50, 275, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.TOON_BARREL_DRAGON, 20, false, false, false, "Duel Monster", Type.DARK, Type.FAIRY, 1.0, 50.0, Abilities.TOON_GUNSLINGER, Abilities.NONE, Abilities.NONE, 550, 85, 90, 75, 115, 75, 110, 30, 50, 275, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.TOON_BLACK_LUSTER_SOLDIER, 20, false, false, true, "Duel Monster", Type.FAIRY, Type.DARK, 1.0, 50.0, Abilities.TOON_CHAOS, Abilities.NONE, Abilities.NONE, 590, 80, 140, 85, 65, 75, 145, 15, 50, 295, GrowthRate.SLOW, null, false),
        new PokemonSpecies(Species.TOON_DARK_MAGICIAN, 20, false, false, false, "Duel Monster", Type.PSYCHIC, Type.FAIRY, 1.0, 50.0, Abilities.TOON_ILLUSION, Abilities.NONE, Abilities.NONE, 550, 60, 55, 65, 140, 85, 145, 30, 50, 275, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.TOON_DARK_MAGICIAN_GIRL, 20, false, false, false, "Duel Monster", Type.PSYCHIC, Type.FAIRY, 1.0, 50.0, Abilities.TOON_SYNERGY, Abilities.NONE, Abilities.NONE, 540, 65, 50, 60, 135, 80, 150, 30, 50, 270, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.TOON_MASKED_SORCERER, 20, false, false, false, "Duel Monster", Type.DARK, Type.FAIRY, 1.0, 50.0, Abilities.DRAW_TIME, Abilities.NONE, Abilities.NONE, 500, 80, 55, 70, 90, 70, 135, 45, 50, 250, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.TOON_MERMAID, 20, false, false, false, "Duel Monster", Type.WATER, Type.FAIRY, 1.0, 50.0, Abilities.TOON_PLOT_ARMOR, Abilities.NONE, Abilities.NONE, 530, 80, 50, 100, 100, 80, 120, 30, 50, 265, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.TOON_SUMMONED_SKULL, 20, false, false, false, "Duel Monster", Type.ELECTRIC, Type.FAIRY, 1.0, 50.0, Abilities.TOON_ELECTRIC_ARCHFIEND, Abilities.NONE, Abilities.NONE, 560, 75, 90, 70, 130, 65, 130, 30, 50, 280, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.TWIN_HEADED_KING_REX, 20, false, false, false, "Duel Monster", Type.FLYING, Type.GROUND, 1.0, 50.0, Abilities.JURASSIC_JAWS, Abilities.NONE, Abilities.NONE, 520, 90, 120, 90, 60, 70, 90, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.ULTIMATE_ANCIENT_GEAR_GOLEM, 20, false, true, false, "Duel Monster", Type.STEEL, Type.GROUND, 1.0, 50.0, Abilities.UNSTOPPABLE_TITAN, Abilities.NONE, Abilities.NONE, 600, 95, 165, 125, 50, 85, 80, 15, 50, 300, GrowthRate.FLUCTUATING, null, false),
        new PokemonSpecies(Species.VALKYRION_THE_MAGNET_WARRIOR, 20, false, false, true, "Duel Monster", Type.ELECTRIC, Type.STEEL, 1.0, 50.0, Abilities.ELECTROMAGNETIC_MASTER, Abilities.NONE, Abilities.NONE, 580, 90, 130, 100, 65, 90, 105, 15, 50, 290, GrowthRate.SLOW, null, false),
        new PokemonSpecies(Species.VOLCANIC_DOOMFIRE, 20, false, false, true, "Duel Monster", Type.DRAGON, Type.FIRE, 1.0, 50.0, Abilities.FLAMING_OBLIVION, Abilities.NONE, Abilities.NONE, 590, 90, 95, 90, 140, 75, 100, 15, 50, 295, GrowthRate.SLOW, null, false),
        new PokemonSpecies(Species.VOLCANIC_ROCKET, 20, false, false, false, "Duel Monster", Type.FIRE, Type.FLYING, 1.0, 50.0, Abilities.ROCKET_IMPACT, Abilities.NONE, Abilities.NONE, 520, 80, 110, 70, 85, 65, 110, 30, 50, 260, GrowthRate.MEDIUM_FAST, null, false),
        new PokemonSpecies(Species.VOLCANIC_HAMMERER, 20, false, false, false, "Duel Monster", Type.FIRE, Type.GROUND, 1.0, 50.0, Abilities.VOLCANIC_CORE, Abilities.NONE, Abilities.NONE, 550, 90, 120, 85, 90, 80, 85, 30, 50, 275, GrowthRate.MEDIUM_FAST, null, false),

    );
    addFormToSpecies(Species.MUK, "noxious", SpeciesFormKey.GLITCH, Type.POISON, Type.DARK, Abilities.TOXIC_KING, Abilities.NIGHTMARATE, Abilities.SWAMP_KING, 587, 103, 126, 82, 74, 146, 56);
    addFormToSpecies(Species.TAUROS, "voltaurus", SpeciesFormKey.GLITCH, Type.NORMAL, Type.ELECTRIC, Abilities.STATIC_CHARGE, Abilities.ELECTROMORPHOSIS, Abilities.EARTH_EATER, 584, 73, 126, 73, 94, 64, 154);
    addFormToSpecies(Species.KECLEON, "kingleon", SpeciesFormKey.GLITCH, Type.NORMAL, null, Abilities.COLOR_CHANGE_DEFENSE, Abilities.COLOR_CHANGE_STEAL, Abilities.PROTEAN, 594, 68, 127, 67, 150, 105, 78);
    addFormToSpecies(Species.GLISCOR, "glicula", SpeciesFormKey.GLITCH, Type.GROUND, Type.POISON, Abilities.SPEED_BOOST, Abilities.STAMINA, Abilities.REGENERATOR, 617, 83, 150, 111, 69, 75, 129);
    addFormToSpecies(Species.MAROWAK, "mamawak", SpeciesFormKey.GLITCH, Type.GHOST, Type.GROUND, Abilities.HAUNTING_ECHO, Abilities.MATERNAL_SHADE, Abilities.SPIRITUAL_BOND, 560, 59, 63, 147, 102, 130, 60);
    addFormToSpecies(Species.NOIVERN, "infernus", SpeciesFormKey.GLITCH, Type.FLYING, Type.DRAGON, Abilities.AERILATE, Abilities.DRAGONS_MAW, Abilities.THICK_FAT, 660, 86, 115, 78, 132, 82, 167);
    addFormToSpecies(Species.FERALIGATR, "fangdrake", SpeciesFormKey.GLITCH, Type.WATER, Type.DRAGON, Abilities.DRAGONS_MAW, Abilities.UNLEASHED, Abilities.SCALE_ARMOR, 646, 79, 165, 133, 78, 83, 109);
    addFormToSpecies(Species.LICKITUNG, "gigilick", SpeciesFormKey.GLITCH, Type.NORMAL, null, Abilities.PIXELATED_TONGUE, Abilities.STATIC_TASTE, Abilities.STATIC_TASTE, 608, 168, 109, 81, 73, 131, 45);
    addFormToSpecies(Species.ONIX, "cybeex", SpeciesFormKey.GLITCH, Type.ROCK, Type.STEEL, Abilities.ROCKY_HORROR_SHOW, Abilities.NIGHTMARATE, Abilities.STATIC, 558, 86, 133, 182, 48, 63, 47);
    addFormToSpecies(Species.CHARIZARD, "charisand", SpeciesFormKey.GLITCH, Type.GROUND, Type.DRAGON, Abilities.GROUND_FLAME, Abilities.UNLEASHED, Abilities.DRAGONS_MAW, 619, 131, 81, 81, 163, 108, 55);
    addFormToSpecies(Species.VENUSAUR, "Mentasaur", SpeciesFormKey.GLITCH, Type.PSYCHIC, Type.POISON, Abilities.PSYCHO_LEAF, Abilities.UNLEASHED, Abilities.NEUROFORCE, 607, 85, 144, 109, 129, 77, 62);
    addFormToSpecies(Species.BLASTOISE, "enchantoise", SpeciesFormKey.GLITCH, Type.FAIRY, Type.ICE, Abilities.MAGICAL_WATER, Abilities.UNLEASHED, Abilities.LOVE_POWER, 614, 82, 70, 123, 123, 149, 68);
    addFormToSpecies(Species.NIDOKING, "nidorath", SpeciesFormKey.GLITCH, Type.GROUND, Type.FIGHTING, Abilities.POISON_KING, Abilities.SOLID_KONG, Abilities.BEAST_BOOST, 616, 123, 161, 102, 81, 70, 79);
    addFormToSpecies(Species.GENGAR, "generagar", SpeciesFormKey.GLITCH, Type.GHOST, Type.ELECTRIC, Abilities.NUCLEAR_ENERGY, Abilities.LEVITATE, Abilities.SCREEPY, 588, 68, 75, 106, 158, 106, 74);
    addFormToSpecies(Species.WEEZING, "fuming", SpeciesFormKey.GLITCH, Type.POISON, Type.FIRE, Abilities.TOXIC_COMBUSTION, Abilities.FLAMING_EMISSION, Abilities.BURNING_DISEASE, 582, 73, 118, 101, 144, 65, 81);
    addFormToSpecies(Species.HITMONLEE, "hitmonnorm", SpeciesFormKey.GLITCH, Type.NORMAL, null, Abilities.NORMALIZE, Abilities.STEADY_STANCE, Abilities.BALANCED_KICK, 569, 62, 96, 67, 121, 148, 75);
    addFormToSpecies(Species.HITMONCHAN, "onehitchan", SpeciesFormKey.GLITCH, Type.FIGHTING, null, Abilities.ADAPTABILITY, Abilities.GOD_FIST, Abilities.MOXIE, 593, 75, 163, 101, 68, 117, 70);
    addFormToSpecies(Species.HITMONLEE, "chanmonlee", SpeciesFormKey.GLITCH_B, Type.FIGHTING, null, Abilities.KICK_PUNCH, Abilities.FINAL_ROUND, Abilities.KNOCKOUT, 547, 50, 139, 76, 35, 151, 96);
    addFormToSpecies(Species.KANGASKHAN, "kangasgone", SpeciesFormKey.GLITCH, Type.GHOST, Type.NORMAL, Abilities.PARENTAL_HAUNTING, Abilities.TECHNICIAN, Abilities.PHANTOM_POUCH, 592, 69, 121, 121, 59, 138, 85);
    addFormToSpecies(Species.SCYTHER, "thanator", SpeciesFormKey.GLITCH, Type.BUG, Type.GHOST, Abilities.HAUNTING_SCYTHE, Abilities.SOUL_COLLECTOR, Abilities.TERRIFY, 612, 70, 172, 104, 55, 76, 135);
    addFormToSpecies([Species.ELECTIVIRE, Species.MAGMORTAR], "magnovire", SpeciesFormKey.GLITCH,
        Type.ELECTRIC, Type.FIRE, Abilities.THUNDER_AND_FIRE, Abilities.ELECTAFIRE_ABSORB,
        Abilities.DIRT_THICK, 632, 75, 140, 61, 157, 87, 112);
    addFormToSpecies(Species.GYARADOS, "dunerados", SpeciesFormKey.GLITCH, Type.GROUND, Type.WATER, Abilities.EARTH_SPEEDER, Abilities.MUDIATE, Abilities.POP_UP, 625, 102, 142, 182, 60, 78, 61);
    addFormToSpecies(Species.LAPRAS, "lavaras", SpeciesFormKey.GLITCH, Type.FIRE, Type.ICE, Abilities.PREHISTORIC_HUNT, Abilities.ARCTIC_BLAZE, Abilities.STEAMIFY, 612, 131, 113, 179, 73, 75, 41);
    addFormToSpecies(Species.PORYGON_Z, "PorygonΩ", SpeciesFormKey.GLITCH, Type.STEEL, Type.FAIRY, Abilities.STAB_NORMAL, Abilities.ADAPTIVE_AI, Abilities.ELECTRIC, 682, 69, 145, 82, 185, 78, 123);
    addFormToSpecies(Species.DRAGONITE, "dragonking", SpeciesFormKey.GLITCH, Type.DRAGON, Type.FAIRY, Abilities.PIXILATE, Abilities.MULTISCALE, Abilities.DRAGON_KING, 655, 84, 85, 115, 135, 156, 80);
    addFormToSpecies(Species.SUDOWOODO, "sudolem", SpeciesFormKey.GLITCH, Type.ROCK, Type.GRASS, Abilities.ORGANIC_TWIST, Abilities.HEALTHY_SOAK, Abilities.CHLOROPHYLL, 614, 110, 161, 145, 58, 76, 64);
    addFormToSpecies(Species.AMBIPOM, "yonipom", SpeciesFormKey.GLITCH, Type.NORMAL, Type.FIGHTING, Abilities.TECHNICIAN, Abilities.BEAST_BOOST, Abilities.SKILL_LINK, 584, 122, 137, 79, 63, 79, 104);
    addFormToSpecies(Species.UNOWN, "alnowning", SpeciesFormKey.GLITCH, Type.PSYCHIC, Type.GHOST, Abilities.CONTRARY, Abilities.EXISTENCE, Abilities.CONTRARY, 544, 64, 69, 95, 133, 118, 65);
    addFormToSpecies(Species.OCTILLERY, "krakken", SpeciesFormKey.GLITCH, Type.WATER, Type.DARK, Abilities.SKILL_LINK, Abilities.INK_BLINDNESS, Abilities.INK_FRY, 590, 80, 123, 76, 104, 134, 73);
    addFormToSpecies(Species.MILTANK, "metalker", SpeciesFormKey.GLITCH, Type.NORMAL, Type.STEEL, Abilities.FUEL_EXCHANGE, Abilities.STAMINA, Abilities.MOO_TIME, 593, 122, 87, 154, 56, 122, 53);
    addFormToSpecies(Species.SLAKING, "slothunter", SpeciesFormKey.GLITCH, Type.NORMAL, null, Abilities.SUNBATHER, Abilities.ENHANCED_FOCUS, Abilities.VACAY_SOUL, 686, 189, 177, 110, 72, 80, 58);
    addFormToSpecies([Species.SOLROCK, Species.LUNATONE], "solunolith", SpeciesFormKey.GLITCH,
        Type.PSYCHIC, null, Abilities.SUN_AND_MOON, Abilities.NIGHT_AND_DAY,
        Abilities.TWO_HALVES, 607, 84, 82, 124, 107, 135, 74);
    addFormToSpecies(Species.REGIROCK, "regimeteor", SpeciesFormKey.GLITCH, Type.ROCK, Type.PSYCHIC, Abilities.ALIEN_ROCK, Abilities.ROBOT, Abilities.GOLEM_PLUS, 652, 112, 156, 191, 47, 70, 76);
    addFormToSpecies(Species.REGIGIGAS, "omnigigas", SpeciesFormKey.GLITCH, Type.NORMAL, null, Abilities.STALL, Abilities.STALL, Abilities.STALL, 676, 113, 177, 142, 85, 80, 80);
    addFormToSpecies(Species.EEVEE, "wispeeon", SpeciesFormKey.GLITCH, Type.GHOST, null, Abilities.GHOSTIFY, Abilities.ADAPTABILITY, Abilities.FOREVER_PARTNER, 527, 123, 65, 51, 106, 75, 106);
    addFormToSpecies(Species.EEVEE, "cybeon", SpeciesFormKey.GLITCH_B, Type.STEEL, null, Abilities.NEW_ADAPTION, Abilities.ADAPTABILITY, Abilities.STEEL_STEALER, 550, 65, 98, 163, 51, 120, 52);
    addFormToSpecies(Species.EEVEE, "teraeon", SpeciesFormKey.GLITCH_C, Type.GROUND, null, Abilities.TERA_FORCE, Abilities.ADAPTABILITY, Abilities.MUDIATE, 605, 125, 159, 102, 65, 72, 81);
    addFormToSpecies(Species.PIKACHU, "pikura", SpeciesFormKey.GLITCH, Type.ELECTRIC, Type.FAIRY, Abilities.ANIMIFIED, Abilities.JUJUTSU_SORCERER, Abilities.RAGE_SOUL, 575, 50, 130, 52, 105, 63, 175);
    addFormToSpecies(Species.GRENINJA, "frogotten", SpeciesFormKey.GLITCH, Type.WATER, Type.DARK, Abilities.CLOAK_OF_SHADOWS, Abilities.ACID_WATER, Abilities.NIGHTMARATE, 655, 67, 119, 72, 168, 74, 155);
    addFormToSpecies(Species.CHARMANDER, "determizard", SpeciesFormKey.GLITCH, Type.FIRE, Type.GHOST, Abilities.EIGHT_BIT_BLAZE, Abilities.CHARRED_MEMORY, Abilities.BLACK_AND_WHITE, 541, 60, 106, 72, 121, 76, 106);
    addFormToSpecies(Species.SNORLAX, "melonax", SpeciesFormKey.GLITCH, Type.NORMAL, Type.WATER, Abilities.SUNBATHER, Abilities.SEED_EATER, Abilities.VACAY_SOUL, 602, 155, 134, 82, 62, 118, 51);
    addFormToSpecies(Species.PIKACHU, "rokachubo", SpeciesFormKey.GLITCH_B, Type.ELECTRIC, Type.STEEL, Abilities.ROBOT, Abilities.IDEAL_FORM, Abilities.ELITE_STATIC, 616, 73, 162, 80, 105, 72, 124);
    addFormToSpecies(Species.CLOYSTER, "treashelter", SpeciesFormKey.GLITCH, Type.ICE, Type.STEEL, Abilities.TREASURE_GUARD, Abilities.GOLDEN_SKILL_LINK, Abilities.TREASURE_PRODUCER, 604, 59, 136, 178, 98, 69, 63);
    addFormToSpecies(Species.LANTURN, "grimjaw", SpeciesFormKey.GLITCH, Type.WATER, Type.DARK, Abilities.EERIE_LIGHT, Abilities.ABYSSAL_LURE, Abilities.NEMO_EATER, 599, 107, 79, 82, 140, 123, 68);
    addFormToSpecies(Species.NUZLEAF, "fibark", SpeciesFormKey.GLITCH, Type.GRASS, Type.FAIRY, Abilities.WOODEN_LIE, Abilities.IM_A_REAL_BOY, Abilities.LIER_LYER, 571, 67, 133, 165, 49, 68, 89);
    addFormToSpecies(Species.CHANDELURE, "bonfyrite", SpeciesFormKey.GLITCH, Type.GHOST, Type.FIRE, Abilities.FLAME_SPIRIT, Abilities.SOUL_BURN, Abilities.FALSE_SAFETY, 647, 72, 124, 81, 184, 81, 106);
    addFormToSpecies(Species.SIMISAGE, "silvaback", SpeciesFormKey.GLITCH_B, Type.FIGHTING, Type.GRASS, Abilities.FOREST_FURY, Abilities.STRAWHAT, Abilities.VINE_FIST, 604, 113, 166, 69, 63, 63, 129);
    addFormToSpecies([Species.SIMISAGE, Species.SIMISEAR, Species.SIMIPOUR], "simizen",
        SpeciesFormKey.GLITCH, Type.GRASS, Type.FIRE, Abilities.ENLIGHTENED,
        Abilities.THE_AVATAR, Abilities.STRAWHAT, 638, 108, 153, 83, 129, 81, 84);
    addFormToSpecies(Species.SMEARGLE, "paletto", SpeciesFormKey.GLITCH, Type.NORMAL, Type.FAIRY, Abilities.HAPPY_LITTLE_ACCIDENTS, Abilities.ORIGINAL_ASMR, Abilities.AFROPOWER, 582, 101, 58, 60, 60, 168, 135);
    addFormToSpecies(Species.REVAVROOM, "extavaroom", SpeciesFormKey.GLITCH, Type.ELECTRIC, Type.STEEL, Abilities.FUEL_EXCHANGE, Abilities.V8_ENGINE, Abilities.SELF_DRIVING, 680, 92, 146, 187, 75, 123, 58);
    addFormToSpecies(Species.MIMIKYU, "mimizado", SpeciesFormKey.GLITCH, Type.FAIRY, Type.FIRE, Abilities.LIMITED_EDITION, Abilities.FIERY_DISGUISE, Abilities.PLAYFUL_BLAZE, 598, 64, 104, 143, 83, 127, 77);
    addFormToSpecies(Species.MIMIKYU, "ninjukyu", SpeciesFormKey.GLITCH_B, Type.FAIRY, Type.WATER, Abilities.AQUA_DISGUISE, Abilities.LIMITED_EDITION, Abilities.PHANTOM_TORRENT, 642, 72, 140, 76, 81, 110, 162);
    addFormToSpecies(Species.MIMIKYU, "mewmewni", SpeciesFormKey.GLITCH_C, Type.FAIRY, Type.PSYCHIC, Abilities.SILLY_PRESSURE, Abilities.TELEKINETIC_DISGUISE, Abilities.LIMITED_EDITION, 702, 86, 137, 90, 157, 95, 137);
    addFormToSpecies(Species.MIMIKYU, "ririkyu", SpeciesFormKey.GLITCH_D, Type.FAIRY, Type.ELECTRIC, Abilities.ELECTRIC_DISGUISE, Abilities.LIMITED_EDITION, Abilities.LOVELY_STATIC, 593, 65, 145, 71, 78, 108, 127);
    addFormToSpecies(Species.MIMIKYU, "regirokuy", SpeciesFormKey.GLITCH_E, Type.FAIRY, Type.ROCK, Abilities.ANCIENT_DISGUISE, Abilities.LIMITED_EDITION, Abilities.MADE_TO_LAST, 622, 62, 101, 190, 50, 154, 65);
    addFormToSpecies(Species.CLAYDOL, "ectonaut", SpeciesFormKey.GLITCH, Type.GROUND, Type.PSYCHIC, Abilities.MULTI_PIECE, Abilities.ALIEN_TYPE, Abilities.WATER_POWERED, 607, 66, 117, 142, 78, 154, 49);
    addFormToSpecies(Species.EISCUE, "dr.eiscicle", SpeciesFormKey.GLITCH, Type.ICE, Type.ROCK, Abilities.MADE_OF_ICE, Abilities.SHREDDED, Abilities.SCULPTED_ICE, 586, 78, 70, 109, 109, 141, 78);
    addFormToSpecies(Species.GOLEM, "moltem", SpeciesFormKey.GLITCH, Type.ROCK, Type.GROUND, Abilities.QUAKER, Abilities.ROCK_FORTRESS, Abilities.ROCK_CONTROL, 608, 112, 147, 172, 65, 78, 33);
    addFormToSpecies(Species.ZANGOOSE, "zandux", SpeciesFormKey.GLITCH, Type.NORMAL, Type.FIGHTING, Abilities.CHAMPION, Abilities.UNSTOPPABLE_POISON, Abilities.SWIFT_CLAWS, 571, 94, 158, 60, 67, 67, 125);
    addFormToSpecies(Species.TRUBBISH, "nucleash", SpeciesFormKey.GLITCH, Type.POISON, Type.DARK, Abilities.TOXIC_OVERLOAD, Abilities.RECYCLE_ENERGY, Abilities.NEET_PRODUCED, 566, 136, 120, 96, 68, 75, 71);
    addFormToSpecies(Species.HAWLUCHA, "plumaestro", SpeciesFormKey.GLITCH, Type.FIGHTING, Type.FLYING, Abilities.LUCHADORS_SPIRIT, Abilities.MASKED_MIGHT, Abilities.NACHO_LIBRE, 614, 105, 153, 75, 77, 79, 125);
    addFormToSpecies(Species.DITTO, "dragomime", SpeciesFormKey.GLITCH, Type.NORMAL, Type.DRAGON, Abilities.PSEUDO_SCALE, Abilities.DRACO_FORM, Abilities.DITTO_TYPE, 594, 76, 129, 71, 106, 144, 69);
    addFormToSpecies(Species.DITTO, "chamelezard", SpeciesFormKey.GLITCH_B, Type.NORMAL, Type.FIRE, Abilities.MORPHING_BLAZE, Abilities.FLAME_FORM, Abilities.DITTO_TYPE, 538, 93, 118, 64, 118, 74, 71);
    addFormToSpecies(Species.DITTO, "pikatto", SpeciesFormKey.GLITCH_C, Type.NORMAL, Type.ELECTRIC, Abilities.REALISTIC_STATIC, Abilities.MASCOT_FORM, Abilities.DITTO_TYPE, 520, 58, 68, 54, 113, 91, 135);
    addFormToSpecies(Species.DITTO, "machitto", SpeciesFormKey.GLITCH_D, Type.NORMAL, Type.FIGHTING, Abilities.COPY_GUARD, Abilities.MUSCLE_FORM, Abilities.DITTO_TYPE, 504, 115, 131, 71, 48, 90, 49);
    addFormToSpecies(Species.DITTO, "mewtate", SpeciesFormKey.GLITCH_E, Type.NORMAL, Type.PSYCHIC, Abilities.UNREAL_PRESSURE, Abilities.PSYCHO_FORM, Abilities.DITTO_TYPE, 594, 74, 74, 68, 154, 104, 121);
    addFormToSpecies(Species.FERALIGATR, "yabbagatr", SpeciesFormKey.GLITCH_B, Type.WATER, Type.ROCK, Abilities.CLUB_CLOBBER, Abilities.YABA_DABA_DOO, Abilities.METEOR_PROOF, 623, 105, 147, 135, 73, 82, 81);
    addFormToSpecies(Species.SHARPEDO, "savagark", SpeciesFormKey.GLITCH, Type.WATER, Type.DARK, Abilities.SHARK_SHRED, Abilities.ATTACK_BOOST, Abilities.NIGHTMARATE, 625, 110, 160, 78, 82, 68, 127);
    addFormToSpecies(Species.WOBBUFFET, "wonstrous", SpeciesFormKey.GLITCH, Type.PSYCHIC, Type.FAIRY, Abilities.BOUNCE_BACK, Abilities.COUNTER_COAT, Abilities.WONDER_GUARD, 542, 153, 48, 66, 104, 119, 51);
    addFormToSpecies(Species.MAGIKARP, "imperiuno", SpeciesFormKey.GLITCH, Type.WATER, Type.STEEL, Abilities.SHINY_SCALE, Abilities.GOLDEN_LUCK, Abilities.ONE_IN_A_MILLION, 617, 140, 128, 71, 83, 111, 84);
    addFormToSpecies(Species.EXCADRILL, "molestrosity", SpeciesFormKey.GLITCH, Type.GROUND, Type.DARK, Abilities.APEX_PREDATOR, Abilities.TERROR_TUNNEL, Abilities.NIGHTMARATE, 596, 105, 150, 162, 52, 60, 68);
    addFormToSpecies(Species.SCRAFTY, "swaggart", SpeciesFormKey.GLITCH, Type.DARK, Type.FIGHTING, Abilities.BOOSHE_FUR_COAT, Abilities.LOOSE_THREADS, Abilities.STREET_SMART, 580, 68, 108, 79, 59, 141, 125);
    addFormToSpecies(Species.SEVIPER, "viperex", SpeciesFormKey.GLITCH, Type.POISON, Type.DARK, Abilities.CHAMPION, Abilities.SNAKE_SCALE, Abilities.DEATH_CLAWS, 535, 69, 140, 62, 108, 63, 93);
    addFormToSpecies(Species.KLINKLANG, "cognarok", SpeciesFormKey.GLITCH, Type.STEEL, Type.ELECTRIC, Abilities.INDUSTRIAL_POWER, Abilities.COG_OVERLOAD, Abilities.MULTI_GEAR, 622, 84, 142, 142, 114, 81, 60);
    addFormToSpecies(Species.SPINDA, "harmonda", SpeciesFormKey.GLITCH, Type.NORMAL, Type.FAIRY, Abilities.BALANCED, Abilities.STEADY_STANCE, Abilities.ENHANCED_FOCUS, 526, 95, 133, 109, 50, 77, 63);
    addFormToSpecies(Species.MEOWTH, "felester", SpeciesFormKey.GLITCH, Type.DARK, Type.NORMAL, Abilities.PRANKSTER, Abilities.LUCKY_SEVEN, Abilities.LAST_LAUGH, 532, 65, 128, 62, 98, 63, 116);
    addFormToSpecies(Species.NINETALES, "tamamo", SpeciesFormKey.GLITCH, Type.FIRE, Type.PSYCHIC, Abilities.FOX_WISDOM, Abilities.ETERNAL_YOUTH, Abilities.FLAMING_CHAKRA, 637, 79, 85, 76, 135, 114, 148);
    addFormToSpecies(Species.SHUCKLE, "tentuckle", SpeciesFormKey.GLITCH, Type.BUG, Type.ROCK, Abilities.SHELL_REPAIR, Abilities.ADAPTABUGILITY, Abilities.SQUEEZER, 636, 50, 101, 194, 59, 161, 71);
    addFormToSpecies(Species.TANGELA, "tanguish", SpeciesFormKey.GLITCH, Type.GRASS, Type.FAIRY, Abilities.GREEN_SPAGHETTI_MONSTER, Abilities.LEECH_VINES, Abilities.REGENERATOR_PLUS, 594, 87, 124, 138, 124, 76, 46);
}

function addFormToSpecies(
    ...
    typeInteractions: {
        strengths: Type[],
        weaknesses: Type[],
        unaffectedByAtk: Type[],
        unaffectedToDef: Type[]
    } | null = null,
    height: number | null = null,
    weight: number | null = null,
    catchRate: number | null = null,
    baseFriendship: number | null = null,
    baseExp: number | null = null
) {
    ...
    speciesArray.forEach(currentSpecies => {
        ...
        if (species) {
            ...
            species.forms.push(newForm);
            if (typeInteractions) {
                if (primaryType >= getMinNightmareTypeValue()) {
                    setNightmareTypeInteractions(primaryType, typeInteractions);
                } else if (secondaryType && secondaryType >= getMinNightmareTypeValue()) {
...
export const speciesStarters = {
    ...
    [Species.ALLIGATORS_SWORD_DRAGON]: 4,
    [Species.ANCIENT_GEAR_BOX]: 4,
    [Species.ARCANA_FORCE_I_THE_MAGICIAN]: 4,
    [Species.ANCIENT_GEAR]: 4,
    [Species.ANCIENT_GEAR_ENGINEER]: 4,
    [Species.ANCIENT_GEAR_KNIGHT]: 4,
    [Species.ARCANA_FORCE_VI_THE_LOVERS]: 4,
    [Species.ARCANA_FORCE_0_THE_FOOL]: 4,
    [Species.ARMED_DRAGON_LV3]: 4,
    [Species.ARMED_DRAGON_LV5]: 4,
    [Species.AVATAR_OF_THE_POT]: 4,
    [Species.AXE_RAIDER]: 4,
    [Species.BABY_DRAGON]: 4,
    [Species.BEAN_SOLDIER]: 4,
    [Species.BEAVER_WARRIOR]: 4,
    [Species.BEIIGE_VANGUARD_OF_DARK_WORLD]: 4,
    [Species.ABAKI]: 4,
    [Species.ABARE_USHIONI]: 4,
    [Species.AGIDO]: 4,
    [Species.AITSU]: 4,
    [Species.ALIEN_GREY]: 4,
    [Species.ALIEN_MARS]: 4,
    [Species.BETA_THE_MAGNET_WARRIOR]: 4,
    [Species.BIG_JAWS]: 4,
    [Species.BIO_PLANT]: 4,
    [Species.BLACK_DRAGONS_CHICK]: 4,
    [Species.BLACK_TYRANNO]: 4,
    [Species.BLADE_KNIGHT]: 4,
    [Species.BLAZING_INPACHI]: 4,
    [Species.BLIZZARD_DRAGON]: 4,
    [Species.BOO_KOO]: 4,
    [Species.BREAKER_THE_MAGICAL_WARRIOR]: 4,
    [Species.CARD_TROOPER]: 4,
    [Species.CASTLE_OF_DARK_ILLUSIONS]: 4,
    [Species.CELTIC_GUARDIAN]: 4,
    [Species.CLAW_REACHER]: 4,
    [Species.CLOUDIAN_GHOST_FOG]: 4,
    [Species.CLOUDIAN_NIMBUSMAN]: 4,
    [Species.CLOUDIAN_SMOKE_BALL]: 4,
    [Species.COPYCAT]: 4,
    [Species.CRYSTAL_BEAST_AMBER_MAMMOTH]: 4,
    [Species.CRYSTAL_BEAST_EMERALD_TORTOISE]: 4,
    [Species.CRYSTAL_BEAST_RUBY_CARBUNCLE]: 4,
    [Species.CRYSTAL_BEAST_TOPAZ_TIGER]: 4,
    [Species.CURSE_OF_DRAGON]: 4,
    [Species.CYBER_SAURUS]: 4,
    [Species.D_D_CRAZY_BEAST]: 4,
    [Species.D_D_TRAINER]: 4,
    [Species.D_D_WARRIOR_LADY]: 4,
    [Species.DANDYLION]: 4,
    [Species.DARK_EYES_ILLUSIONIST]: 4,
    [Species.DARK_RESONATOR]: 4,
    [Species.DARK_RABBIT]: 4,
    [Species.DARK_WORLD_THORNS]: 4,
    [Species.DARKFIRE_DRAGON]: 4,
    [Species.DRILLAGO]: 4,
    [Species.ELEMENTAL_HERO_BURSTINATRIX]: 4,
    [Species.ELEMENTAL_HERO_CLAYMAN]: 4,
    [Species.ELEMENTAL_HERO_NEOS_ALIUS]: 4,
    [Species.EVILSWARM_MANDRAGORA]: 4,
    [Species.EVILSWARM_SALAMANDRA]: 4,
    [Species.FENRIR]: 4,
    [Species.FERAL_IMP]: 4,
    [Species.FIEND_SWORD]: 4,
    [Species.FOSSIL_DYNA_PACHYCEPHALO]: 4,
    [Species.GAMMA_THE_MAGNET_WARRIOR]: 4,
    [Species.GAZELLE_THE_KING_OF_MYTHICAL_BEASTS]: 4,
    [Species.GELLENDUO]: 4,
    [Species.GENEX_ALLY_BIRDMAN]: 4,
    [Species.GHOSTRICK_GHOUL]: 4,
    [Species.GHOSTRICK_MUMMY]: 4,
    [Species.GIGOBYTE]: 4,
    [Species.GRAVEROBBER]: 4,
    [Species.GREAT_WHITE]: 4,
    [Species.GREEN_GADGET]: 4,
    [Species.GRIFFORE]: 4,
    [Species.GUARDIAN_GRARL]: 4,
    [Species.HANE_HANE]: 4,
    [Species.HEADLESS_KNIGHT]: 4,
    [Species.HITOTSU_ME_GIANT]: 4,
    [Species.HUMANOID_SLIME]: 4,
    [Species.HUNGRY_BURGER]: 4,
    [Species.HYDROGEDDON]: 4,
    [Species.HYPER_HAMMERHEAD]: 4,
    [Species.JUNK_WARRIOR]: 4,
    [Species.KOITSU]: 4,
    [Species.KOZAKY]: 4,
    [Species.KURIBOH]: 4,
    [Species.LORD_OF_D]: 4,
    [Species.MAGICIANS_ROBE]: 4,
    [Species.MILLENNIUM_SCORPION]: 4,
    [Species.MORPHING_JAR]: 4,
    [Species.MUKA_MUKA]: 4,
    [Species.NUMBER_22_ZOMBIESTEIN]: 4,
    [Species.OJAMA_BLACK_GREEN]: 4,
    [Species.OXYGEDDON]: 4,
    [Species.PALADIN_OF_THE_CURSED_DRAGON]: 4,
    [Species.PANTHER_WARRIOR]: 4,
    [Species.PAPA_CORN]: 4,
    [Species.PLAGUESPREADER_ZOMBIE]: 4,
    [Species.SNOWMAN_EATER]: 4,
    [Species.SPEED_WARRIOR]: 4,
    [Species.STEEL_OGRE_GROTTO_1]: 4,
    [Species.YELLOW_GADGET]: 4,
    [Species.THE_FABLED_CERBURREL]: 4,
    [Species.THE_FABLED_GANASHIA]: 4,
    [Species.THE_TRICKY]: 4,
    [Species.TIME_WIZARD_OF_TOMORROW]: 4,
    [Species.TOGEX]: 4,
    [Species.ZOMBYRA_THE_DARK]: 4,
    [Species.WOODLAND_SPRITE]: 4,
    [Species.VOLCANIC_SHELL]: 4,
    [Species.TOON_ALLIGATOR]: 4,
    [Species.TOON_MASKED_SORCERER]: 4,
    [Species.TOON_MERMAID]: 4,
    [Species.TWIN_HEADED_KING_REX]: 4,
    [Species.VOLCANIC_ROCKET]: 4,
